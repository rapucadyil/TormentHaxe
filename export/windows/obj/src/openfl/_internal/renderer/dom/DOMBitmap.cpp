...
HX_LOCAL_STACK_FRAME(_hx_pos_f172e181152f6262_121_renderImage,"openfl._internal.renderer.dom.DOMBitmap","renderImage",0x8ed26a81,"openfl._internal.renderer.dom.DOMBitmap.renderImage","openfl/_internal/renderer/dom/DOMBitmap.hx",121,0x32124034)
namespace openfl{
namespace _internal{
namespace renderer{
namespace dom{
...
void DOMBitmap_obj::renderImage( ::openfl::display::Bitmap bitmap, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_f172e181152f6262_121_renderImage)
            	}
