...
HX_LOCAL_STACK_FRAME(_hx_pos_6e05dc14770b0678_323___setBlendMode,"openfl.display.DOMRenderer","__setBlendMode",0xbf231cc5,"openfl.display.DOMRenderer.__setBlendMode","openfl/display/DOMRenderer.hx",323,0x3d2c4865)
HX_LOCAL_STACK_FRAME(_hx_pos_6e05dc14770b0678_403___updateClip,"openfl.display.DOMRenderer","__updateClip",0xffe7bf2c,"openfl.display.DOMRenderer.__updateClip","openfl/display/DOMRenderer.hx",403,0x3d2c4865)
namespace openfl{
namespace display{
...
void DOMRenderer_obj::_hx___setBlendMode( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_6e05dc14770b0678_323___setBlendMode)
HXLINE( 325)		if (hx::IsNotNull( this->_hx___overrideBlendMode )) {
HXLINE( 325)			value = this->_hx___overrideBlendMode;
            		}
HXLINE( 326)		if (hx::IsEq( this->_hx___blendMode,value )) {
HXLINE( 326)			return;
            		}
HXLINE( 328)		this->_hx___blendMode = value;
            	}


void DOMRenderer_obj::_hx___updateClip( ::openfl::display::DisplayObject displayObject){
            	HX_GC_STACKFRAME(&_hx_pos_6e05dc14770b0678_403___updateClip)
HXDLIN( 403)		if (hx::IsNull( this->_hx___currentClipRect )) {
HXLINE( 405)			displayObject->_hx___worldClipChanged = hx::IsNotNull( displayObject->_hx___worldClip );
HXLINE( 406)			displayObject->_hx___worldClip = null();
            		}
            		else {
HXLINE( 410)			if (hx::IsNull( displayObject->_hx___worldClip )) {
HXLINE( 412)				displayObject->_hx___worldClip =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            			}
HXLINE( 416)			 ::openfl::geom::Rectangle clip = ::openfl::geom::Rectangle_obj::_hx___pool->get();
HXLINE( 417)			 ::openfl::geom::Matrix matrix = ::openfl::geom::Matrix_obj::_hx___pool->get();
HXLINE( 419)			matrix->copyFrom(displayObject->_hx___renderTransform);
HXLINE( 420)			matrix->invert();
HXLINE( 422)			this->_hx___currentClipRect->_hx___transform(clip,matrix);
HXLINE( 424)			if (clip->equals(displayObject->_hx___worldClip)) {
HXLINE( 426)				displayObject->_hx___worldClipChanged = false;
            			}
            			else {
HXLINE( 430)				displayObject->_hx___worldClip->copyFrom(clip);
HXLINE( 431)				displayObject->_hx___worldClipChanged = true;
            			}
HXLINE( 435)			::openfl::geom::Rectangle_obj::_hx___pool->release(clip);
HXLINE( 436)			::openfl::geom::Matrix_obj::_hx___pool->release(matrix);
            		}
            	}
