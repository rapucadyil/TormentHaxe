...
HX_DEFINE_STACK_FRAME(_hx_pos_60bc3ea1ea35efff_76_new,"openfl._internal.renderer.context3D.Context3DState","new",0xd2160e4c,"openfl._internal.renderer.context3D.Context3DState.new","openfl/_internal/renderer/context3D/Context3DState.hx",76,0x9f748564)
namespace openfl{
namespace _internal{
namespace renderer{
namespace context3D{
...
void Context3DState_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_60bc3ea1ea35efff_76_new)
HXLINE(  78)		this->backBufferEnableDepthAndStencil = false;
HXLINE(  79)		this->blendDestinationAlphaFactor = (int)9;
HXLINE(  80)		this->blendSourceAlphaFactor = (int)2;
HXLINE(  81)		this->blendDestinationRGBFactor = (int)9;
HXLINE(  82)		this->blendSourceRGBFactor = (int)2;
...
HXLINE(  87)		this->culling = (int)3;
HXLINE(  88)		this->depthCompareMode = (int)4;
...
HXLINE(  92)		this->stencilCompareMode = (int)0;
HXLINE(  93)		this->stencilDepthFail = (int)5;
HXLINE(  94)		this->stencilFail = (int)5;
HXLINE(  95)		this->stencilPass = (int)5;
HXLINE(  96)		this->stencilReadMask = (int)255;
HXLINE(  97)		this->stencilReferenceValue = (int)0;
HXLINE(  98)		this->stencilTriangleFace = (int)2;
HXLINE(  99)		this->stencilWriteMask = (int)255;
