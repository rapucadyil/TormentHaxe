...
HX_LOCAL_STACK_FRAME(_hx_pos_dbfa7e5fc0c22ef6_18_fromString,"openfl.geom._Orientation3D.Orientation3D_Impl_","fromString",0xa47116a0,"openfl.geom._Orientation3D.Orientation3D_Impl_.fromString","openfl/geom/Orientation3D.hx",18,0xf4ac08f1)
HX_LOCAL_STACK_FRAME(_hx_pos_dbfa7e5fc0c22ef6_31_toString,"openfl.geom._Orientation3D.Orientation3D_Impl_","toString",0xf11d8e31,"openfl.geom._Orientation3D.Orientation3D_Impl_.toString","openfl/geom/Orientation3D.hx",31,0xf4ac08f1)
HX_LOCAL_STACK_FRAME(_hx_pos_dbfa7e5fc0c22ef6_12_boot,"openfl.geom._Orientation3D.Orientation3D_Impl_","boot",0xe951db37,"openfl.geom._Orientation3D.Orientation3D_Impl_.boot","openfl/geom/Orientation3D.hx",12,0xf4ac08f1)
...
bool Orientation3D_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Orientation3D_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_dbfa7e5fc0c22ef6_18_fromString)
...
::String Orientation3D_Impl__obj::toString(int value){
            	HX_STACKFRAME(&_hx_pos_dbfa7e5fc0c22ef6_31_toString)
HXDLIN(  31)		switch((int)(value)){
            			case (int)0: {
HXLINE(  33)				return HX_("axisAngle",72,2f,86,7c);
            			}
            			break;
            			case (int)1: {
HXLINE(  34)				return HX_("eulerAngles",89,d7,c4,64);
            			}
            			break;
            			case (int)2: {
HXLINE(  35)				return HX_("quaternion",1e,0d,ca,1b);
            			}
            			break;
            			default:{
...
{
{
            	HX_STACKFRAME(&_hx_pos_dbfa7e5fc0c22ef6_12_boot)
HXDLIN(  12)		AXIS_ANGLE = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_dbfa7e5fc0c22ef6_13_boot)
HXDLIN(  13)		EULER_ANGLES = (int)1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_dbfa7e5fc0c22ef6_14_boot)
HXDLIN(  14)		QUATERNION = (int)2;
            	}
}
