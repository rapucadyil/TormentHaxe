...
HX_DEFINE_STACK_FRAME(_hx_pos_dc6fd8f0bbdab31a_1126_new,"lime._internal.backend.native.TouchEventInfo","new",0xc006dded,"lime._internal.backend.native.TouchEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",1126,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_dc6fd8f0bbdab31a_1142_clone,"lime._internal.backend.native.TouchEventInfo","clone",0xa51e5e2a,"lime._internal.backend.native.TouchEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",1142,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
int device = __o_device.Default(0);
            	HX_STACKFRAME(&_hx_pos_dc6fd8f0bbdab31a_1126_new)
HXLINE(1128)		this->type = type;
HXLINE(1129)		this->x = x;
HXLINE(1130)		this->y = y;
HXLINE(1131)		this->id = id;
HXLINE(1132)		this->dx = dx;
HXLINE(1133)		this->dy = dy;
HXLINE(1134)		this->pressure = pressure;
HXLINE(1135)		this->device = device;
            	}
...
bool TouchEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::TouchEventInfo TouchEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_dc6fd8f0bbdab31a_1142_clone)
HXDLIN(1142)		return  ::lime::_internal::backend::native::TouchEventInfo_obj::__alloc( HX_CTX ,this->type,this->x,this->y,this->id,this->dx,this->dy,this->pressure,this->device);
            	}
