...
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_80_closePath,"openfl._internal.renderer.canvas.CanvasGraphics","closePath",0x0426588d,"openfl._internal.renderer.canvas.CanvasGraphics.closePath","openfl/_internal/renderer/canvas/CanvasGraphics.hx",80,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_121_createBitmapFill,"openfl._internal.renderer.canvas.CanvasGraphics","createBitmapFill",0x2a5c3b1e,"openfl._internal.renderer.canvas.CanvasGraphics.createBitmapFill","openfl/_internal/renderer/canvas/CanvasGraphics.hx",121,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_128_createGradientPattern,"openfl._internal.renderer.canvas.CanvasGraphics","createGradientPattern",0x6cf339b4,"openfl._internal.renderer.canvas.CanvasGraphics.createGradientPattern","openfl/_internal/renderer/canvas/CanvasGraphics.hx",128,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_194_createTempPatternCanvas,"openfl._internal.renderer.canvas.CanvasGraphics","createTempPatternCanvas",0x07b48808,"openfl._internal.renderer.canvas.CanvasGraphics.createTempPatternCanvas","openfl/_internal/renderer/canvas/CanvasGraphics.hx",194,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_220_drawRoundRect,"openfl._internal.renderer.canvas.CanvasGraphics","drawRoundRect",0x4e8f7efe,"openfl._internal.renderer.canvas.CanvasGraphics.drawRoundRect","openfl/_internal/renderer/canvas/CanvasGraphics.hx",220,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_256_endFill,"openfl._internal.renderer.canvas.CanvasGraphics","endFill",0x3478970e,"openfl._internal.renderer.canvas.CanvasGraphics.endFill","openfl/_internal/renderer/canvas/CanvasGraphics.hx",256,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_267_endStroke,"openfl._internal.renderer.canvas.CanvasGraphics","endStroke",0x411cf503,"openfl._internal.renderer.canvas.CanvasGraphics.endStroke","openfl/_internal/renderer/canvas/CanvasGraphics.hx",267,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_522_hitTest,"openfl._internal.renderer.canvas.CanvasGraphics","hitTest",0xf1176f55,"openfl._internal.renderer.canvas.CanvasGraphics.hitTest","openfl/_internal/renderer/canvas/CanvasGraphics.hx",522,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_529_isCCW,"openfl._internal.renderer.canvas.CanvasGraphics","isCCW",0xce74af1d,"openfl._internal.renderer.canvas.CanvasGraphics.isCCW","openfl/_internal/renderer/canvas/CanvasGraphics.hx",529,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_534_normalizeUVT,"openfl._internal.renderer.canvas.CanvasGraphics","normalizeUVT",0x11b66056,"openfl._internal.renderer.canvas.CanvasGraphics.normalizeUVT","openfl/_internal/renderer/canvas/CanvasGraphics.hx",534,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_583_playCommands,"openfl._internal.renderer.canvas.CanvasGraphics","playCommands",0x147605cc,"openfl._internal.renderer.canvas.CanvasGraphics.playCommands","openfl/_internal/renderer/canvas/CanvasGraphics.hx",583,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_1247_render,"openfl._internal.renderer.canvas.CanvasGraphics","render",0x7dc3ee46,"openfl._internal.renderer.canvas.CanvasGraphics.render","openfl/_internal/renderer/canvas/CanvasGraphics.hx",1247,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_1600_renderMask,"openfl._internal.renderer.canvas.CanvasGraphics","renderMask",0xfa8ef652,"openfl._internal.renderer.canvas.CanvasGraphics.renderMask","openfl/_internal/renderer/canvas/CanvasGraphics.hx",1600,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_1713_setSmoothing,"openfl._internal.renderer.canvas.CanvasGraphics","setSmoothing",0x84b8ec62,"openfl._internal.renderer.canvas.CanvasGraphics.setSmoothing","openfl/_internal/renderer/canvas/CanvasGraphics.hx",1713,0x0b9ff65e)
...
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_45_boot,"openfl._internal.renderer.canvas.CanvasGraphics","boot",0x56fa6b22,"openfl._internal.renderer.canvas.CanvasGraphics.boot","openfl/_internal/renderer/canvas/CanvasGraphics.hx",45,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_52_boot,"openfl._internal.renderer.canvas.CanvasGraphics","boot",0x56fa6b22,"openfl._internal.renderer.canvas.CanvasGraphics.boot","openfl/_internal/renderer/canvas/CanvasGraphics.hx",52,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_59_boot,"openfl._internal.renderer.canvas.CanvasGraphics","boot",0x56fa6b22,"openfl._internal.renderer.canvas.CanvasGraphics.boot","openfl/_internal/renderer/canvas/CanvasGraphics.hx",59,0x0b9ff65e)
namespace openfl{
namespace _internal{
namespace renderer{
namespace canvas{
...
bool strokeBefore = __o_strokeBefore.Default(false);
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_80_closePath)
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(CanvasGraphics_obj,closePath,(void))
 ...
 ::Dynamic CanvasGraphics_obj::createBitmapFill( ::openfl::display::BitmapData bitmap,bool bitmapRepeat,bool smooth){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_121_createBitmapFill)
...
void CanvasGraphics_obj::createGradientPattern( ::Dynamic type,::cpp::VirtualArray colors,::cpp::VirtualArray alphas,::cpp::VirtualArray ratios, ::openfl::geom::Matrix matrix, ::Dynamic spreadMethod, ::Dynamic interpolationMethod,Float focalPointRatio){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_128_createGradientPattern)
            	}
...
void CanvasGraphics_obj::createTempPatternCanvas( ::openfl::display::BitmapData bitmap,bool repeat,int width,int height){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_194_createTempPatternCanvas)
            	}
...
void CanvasGraphics_obj::drawRoundRect(Float x,Float y,Float width,Float height,Float ellipseWidth, ::Dynamic ellipseHeight){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_220_drawRoundRect)
            	}
...
void CanvasGraphics_obj::endFill(){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_256_endFill)
            	}
...
void CanvasGraphics_obj::endStroke(){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_267_endStroke)
            	}
...
bool CanvasGraphics_obj::hitTest( ::openfl::display::Graphics graphics,Float x,Float y){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_522_hitTest)
HXDLIN( 522)		return false;
            	}
...
bool CanvasGraphics_obj::isCCW(Float x1,Float y1,Float x2,Float y2,Float x3,Float y3){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_529_isCCW)
HXDLIN( 529)		return ((((x2 - x1) * (y3 - y1)) - ((y2 - y1) * (x3 - x1))) < (int)0);
            	}
...
bool skipT = __o_skipT.Default(false);
            	HX_GC_STACKFRAME(&_hx_pos_ca7a636da47018f2_534_normalizeUVT)
HXLINE( 536)		Float max = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 537)		Float tmp = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 538)		int len = uvt->get_length();
HXLINE( 540)		{
HXLINE( 540)			int _g1 = (int)1;
HXDLIN( 540)			int _g = (len + (int)1);
HXDLIN( 540)			while((_g1 < _g)){
HXLINE( 540)				_g1 = (_g1 + (int)1);
HXDLIN( 540)				int t = (_g1 - (int)1);
HXLINE( 542)				bool _hx_tmp;
HXDLIN( 542)				if (skipT) {
HXLINE( 542)					_hx_tmp = (hx::Mod(t,(int)3) == (int)0);
            				}
            				else {
...
HXLINE( 548)				tmp = uvt->get((t - (int)1));
HXLINE( 550)				if ((max < tmp)) {
HXLINE( 552)					max = tmp;
            				}
            			}
            		}
HXLINE( 558)		if (!(skipT)) {
HXLINE( 560)			return  ::Dynamic(hx::Anon_obj::Create(2)
            				->setFixed(0,HX_("max",a4,0a,53,00),max)
            				->setFixed(1,HX_("uvt",f3,2e,59,00),uvt));
            		}
HXLINE( 564)		int length = null();
HXDLIN( 564)		bool fixed = null();
HXDLIN( 564)		 ::openfl::_Vector::FloatVector result =  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length,fixed,null(),true);
HXLINE( 566)		{
HXLINE( 566)			int _g11 = (int)1;
HXDLIN( 566)			int _g2 = (len + (int)1);
HXDLIN( 566)			while((_g11 < _g2)){
HXLINE( 566)				_g11 = (_g11 + (int)1);
HXDLIN( 566)				int t1 = (_g11 - (int)1);
HXLINE( 568)				bool _hx_tmp1;
HXDLIN( 568)				if (skipT) {
HXLINE( 568)					_hx_tmp1 = (hx::Mod(t1,(int)3) == (int)0);
            				}
            				else {
...
HXLINE( 574)				result->push(uvt->get((t1 - (int)1)));
            			}
            		}
HXLINE( 578)		return  ::Dynamic(hx::Anon_obj::Create(2)
            			->setFixed(0,HX_("max",a4,0a,53,00),max)
...
bool stroke = __o_stroke.Default(false);
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_583_playCommands)
            	}
...
void CanvasGraphics_obj::render( ::openfl::display::Graphics graphics, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_1247_render)
            	}
...
void CanvasGraphics_obj::renderMask( ::openfl::display::Graphics graphics, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_1600_renderMask)
            	}
...
void CanvasGraphics_obj::setSmoothing(bool smooth){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_1713_setSmoothing)
            	}
...
{
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_45_boot)
HXDLIN(  45)		TAN22 = ((Float)0.4142135623730950488016887242097);
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_ca7a636da47018f2_52_boot)
HXDLIN(  52)		fillCommands =  ::openfl::_internal::renderer::DrawCommandBuffer_obj::__alloc( HX_CTX );
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_ca7a636da47018f2_59_boot)
HXDLIN(  59)		strokeCommands =  ::openfl::_internal::renderer::DrawCommandBuffer_obj::__alloc( HX_CTX );
            	}
}
