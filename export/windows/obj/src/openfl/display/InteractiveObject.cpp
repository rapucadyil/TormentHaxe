...
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1194___allowMouseFocus,"openfl.display.InteractiveObject","__allowMouseFocus",0x4a3f2aa5,"openfl.display.InteractiveObject.__allowMouseFocus","openfl/display/InteractiveObject.hx",1194,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1199___getInteractive,"openfl.display.InteractiveObject","__getInteractive",0xf3ec43c3,"openfl.display.InteractiveObject.__getInteractive","openfl/display/InteractiveObject.hx",1199,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1218___hitTest,"openfl.display.InteractiveObject","__hitTest",0x5938388e,"openfl.display.InteractiveObject.__hitTest","openfl/display/InteractiveObject.hx",1218,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1228___tabTest,"openfl.display.InteractiveObject","__tabTest",0xbc287590,"openfl.display.InteractiveObject.__tabTest","openfl/display/InteractiveObject.hx",1228,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1246_get_tabEnabled,"openfl.display.InteractiveObject","get_tabEnabled",0x09837aec,"openfl.display.InteractiveObject.get_tabEnabled","openfl/display/InteractiveObject.hx",1246,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1251_set_tabEnabled,"openfl.display.InteractiveObject","set_tabEnabled",0x29a36360,"openfl.display.InteractiveObject.set_tabEnabled","openfl/display/InteractiveObject.hx",1251,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1267_get_tabIndex,"openfl.display.InteractiveObject","get_tabIndex",0x2bde10bd,"openfl.display.InteractiveObject.get_tabIndex","openfl/display/InteractiveObject.hx",1267,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1272_set_tabIndex,"openfl.display.InteractiveObject","set_tabIndex",0x40d73431,"openfl.display.InteractiveObject.set_tabIndex","openfl/display/InteractiveObject.hx",1272,0x983a3689)
namespace openfl{
namespace display{
...
bool InteractiveObject_obj::_hx___allowMouseFocus(){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1194___allowMouseFocus)
HXDLIN(1194)		return this->get_tabEnabled();
            	}
...
bool InteractiveObject_obj::_hx___getInteractive(::Array< ::Dynamic> stack){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1199___getInteractive)
HXLINE(1201)		if (hx::IsNotNull( stack )) {
HXLINE(1203)			stack->push(hx::ObjectPtr<OBJ_>(this));
HXLINE(1205)			if (hx::IsNotNull( this->parent )) {
HXLINE(1207)				this->parent->_hx___getInteractive(stack);
            			}
            		}
...
bool InteractiveObject_obj::_hx___hitTest(Float x,Float y,bool shapeFlag,::Array< ::Dynamic> stack,bool interactiveOnly, ::openfl::display::DisplayObject hitObject){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1218___hitTest)
HXLINE(1220)		bool _hx_tmp;
HXDLIN(1220)		bool _hx_tmp1;
HXDLIN(1220)		if (!(!(hitObject->get_visible()))) {
HXLINE(1220)			_hx_tmp1 = this->_hx___isMask;
            		}
            		else {
HXLINE(1220)			_hx_tmp1 = true;
            		}
HXDLIN(1220)		if (!(_hx_tmp1)) {
HXLINE(1220)			if (interactiveOnly) {
HXLINE(1220)				_hx_tmp = !(this->mouseEnabled);
            			}
            			else {
...
HXLINE(1221)		return this->super::_hx___hitTest(x,y,shapeFlag,stack,interactiveOnly,hitObject);
            	}


void InteractiveObject_obj::_hx___tabTest(::Array< ::Dynamic> stack){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1228___tabTest)
HXDLIN(1228)		if (this->get_tabEnabled()) {
HXLINE(1230)			stack->push(hx::ObjectPtr<OBJ_>(this));
            		}
            	}
...
bool InteractiveObject_obj::get_tabEnabled(){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1246_get_tabEnabled)
HXDLIN(1246)		if (hx::IsEq( this->_hx___tabEnabled,true )) {
HXDLIN(1246)			return true;
            		}
            		else {
HXDLIN(1246)			return false;
            		}
HXDLIN(1246)		return false;
            	}
...
bool InteractiveObject_obj::set_tabEnabled(bool value){
            	HX_GC_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1251_set_tabEnabled)
HXLINE(1253)		if (hx::IsNotEq( this->_hx___tabEnabled,value )) {
HXLINE(1255)			this->_hx___tabEnabled = value;
HXLINE(1257)			this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("tabEnabledChange",3c,45,98,72),true,false));
            		}
HXLINE(1260)		return this->_hx___tabEnabled;
            	}
...
int InteractiveObject_obj::get_tabIndex(){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1267_get_tabIndex)
HXDLIN(1267)		return this->_hx___tabIndex;
            	}
...
int InteractiveObject_obj::set_tabIndex(int value){
            	HX_GC_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1272_set_tabIndex)
HXLINE(1274)		if ((this->_hx___tabIndex != value)) {
HXLINE(1276)			if ((value < (int)-1)) {
HXLINE(1276)				HX_STACK_DO_THROW( ::openfl::errors::RangeError_obj::__alloc( HX_CTX ,(HX_("Parameter tabIndex must be a non-negative number; got ",9c,f8,24,a4) + value)));
            			}
HXLINE(1278)			this->_hx___tabIndex = value;
HXLINE(1280)			this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("tabIndexChange",cd,1d,78,90),true,false));
            		}
HXLINE(1283)		return this->_hx___tabIndex;
            	}
