...
HX_DEFINE_STACK_FRAME(_hx_pos_2880df2f01d21cf0_785_new,"openfl.display3D.Uniform","new",0x27a38f2d,"openfl.display3D.Uniform.new","openfl/display3D/Program3D.hx",785,0x0a985b04)
HX_LOCAL_STACK_FRAME(_hx_pos_2880df2f01d21cf0_795_flush,"openfl.display3D.Uniform","flush",0x6c722ed1,"openfl.display3D.Uniform.flush","openfl/display3D/Program3D.hx",795,0x0a985b04)
HX_LOCAL_STACK_FRAME(_hx_pos_2880df2f01d21cf0_836___getUniformRegisters,"openfl.display3D.Uniform","__getUniformRegisters",0xe23bc87f,"openfl.display3D.Uniform.__getUniformRegisters","openfl/display3D/Program3D.hx",836,0x0a985b04)
namespace openfl{
namespace display3D{

void Uniform_obj::__construct( ::openfl::display3D::Context3D context){
            	HX_GC_STACKFRAME(&_hx_pos_2880df2f01d21cf0_785_new)
HXLINE( 787)		this->context = context;
HXLINE( 789)		this->isDirty = true;
HXLINE( 790)		 ::lime::utils::BytePointerData this1 =  ::lime::utils::BytePointerData_obj::__alloc( HX_CTX ,null(),(int)0);
HXDLIN( 790)		this->regDataPointer = this1;
            	}
...
void Uniform_obj::flush(){
            	HX_STACKFRAME(&_hx_pos_2880df2f01d21cf0_795_flush)
HXLINE( 800)		 ::lime::_internal::backend::native::NativeOpenGLRenderContext gl = this->context->_hx___context->gles2;
HXLINE( 803)		int index = (this->regIndex * (int)4);
HXLINE( 804)		{
HXLINE( 804)			int _g = this->type;
HXDLIN( 804)			switch((int)(_g)){
            				case (int)35664: {
HXLINE( 818)					int location = this->location;
HXDLIN( 818)					int count = this->regCount;
HXDLIN( 818)					int size = (this->regCount * (int)2);
HXDLIN( 818)					 ::lime::utils::BytePointerData v = this->regDataPointer;
HXDLIN( 818)					 ::lime::utils::ArrayBufferView v1 = this->regData;
HXDLIN( 818)					::lime::utils::_BytePointer::BytePointer_Impl__obj::set(v,null(),v1,null(),(index * (int)4));
HXDLIN( 818)					gl->uniform2fv(location,count,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer));
            				}
            				break;
            				case (int)35665: {
HXLINE( 819)					int location1 = this->location;
HXDLIN( 819)					int count1 = this->regCount;
HXDLIN( 819)					int size1 = (this->regCount * (int)3);
HXDLIN( 819)					 ::lime::utils::BytePointerData v2 = this->regDataPointer;
HXDLIN( 819)					 ::lime::utils::ArrayBufferView v3 = this->regData;
HXDLIN( 819)					::lime::utils::_BytePointer::BytePointer_Impl__obj::set(v2,null(),v3,null(),(index * (int)4));
HXDLIN( 819)					gl->uniform3fv(location1,count1,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer));
            				}
            				break;
            				case (int)35666: {
HXLINE( 820)					int location2 = this->location;
HXDLIN( 820)					int count2 = this->regCount;
HXDLIN( 820)					int size2 = (this->regCount * (int)4);
HXDLIN( 820)					 ::lime::utils::BytePointerData v4 = this->regDataPointer;
HXDLIN( 820)					 ::lime::utils::ArrayBufferView v5 = this->regData;
HXDLIN( 820)					::lime::utils::_BytePointer::BytePointer_Impl__obj::set(v4,null(),v5,null(),(index * (int)4));
HXDLIN( 820)					gl->uniform4fv(location2,count2,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer));
            				}
            				break;
            				case (int)35674: {
HXLINE( 815)					int location3 = this->location;
HXDLIN( 815)					int count3 = this->size;
HXDLIN( 815)					int size3 = ((this->size * (int)2) * (int)2);
HXDLIN( 815)					 ::lime::utils::BytePointerData v6 = this->regDataPointer;
HXDLIN( 815)					 ::lime::utils::ArrayBufferView v7 = this->regData;
HXDLIN( 815)					::lime::utils::_BytePointer::BytePointer_Impl__obj::set(v6,null(),v7,null(),(index * (int)4));
HXDLIN( 815)					gl->uniformMatrix2fv(location3,count3,false,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer));
            				}
            				break;
            				case (int)35675: {
HXLINE( 816)					int location4 = this->location;
HXDLIN( 816)					int count4 = this->size;
HXDLIN( 816)					int size4 = ((this->size * (int)3) * (int)3);
HXDLIN( 816)					 ::lime::utils::BytePointerData v8 = this->regDataPointer;
HXDLIN( 816)					 ::lime::utils::ArrayBufferView v9 = this->regData;
HXDLIN( 816)					::lime::utils::_BytePointer::BytePointer_Impl__obj::set(v8,null(),v9,null(),(index * (int)4));
HXDLIN( 816)					gl->uniformMatrix3fv(location4,count4,false,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer));
            				}
            				break;
            				case (int)35676: {
HXLINE( 817)					int location5 = this->location;
HXDLIN( 817)					int count5 = this->size;
HXDLIN( 817)					int size5 = ((this->size * (int)4) * (int)4);
HXDLIN( 817)					 ::lime::utils::BytePointerData v10 = this->regDataPointer;
HXDLIN( 817)					 ::lime::utils::ArrayBufferView v11 = this->regData;
HXDLIN( 817)					::lime::utils::_BytePointer::BytePointer_Impl__obj::set(v10,null(),v11,null(),(index * (int)4));
HXDLIN( 817)					gl->uniformMatrix4fv(location5,count5,false,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer));
            				}
            				break;
            				default:{
HXLINE( 821)					int location6 = this->location;
HXDLIN( 821)					int count6 = this->regCount;
HXDLIN( 821)					int size6 = (this->regCount * (int)4);
HXDLIN( 821)					 ::lime::utils::BytePointerData v12 = this->regDataPointer;
HXDLIN( 821)					 ::lime::utils::ArrayBufferView v13 = this->regData;
HXDLIN( 821)					::lime::utils::_BytePointer::BytePointer_Impl__obj::set(v12,null(),v13,null(),(index * (int)4));
HXDLIN( 821)					gl->uniform4fv(location6,count6,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer));
            				}
            			}
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Uniform_obj,flush,(void))
 ...
 ::lime::utils::BytePointerData Uniform_obj::_hx___getUniformRegisters(int index,int size){
            	HX_STACKFRAME(&_hx_pos_2880df2f01d21cf0_836___getUniformRegisters)
HXLINE( 838)		 ::lime::utils::BytePointerData _hx_tmp = this->regDataPointer;
HXDLIN( 838)		 ::lime::utils::ArrayBufferView _hx_tmp1 = this->regData;
HXDLIN( 838)		::lime::utils::_BytePointer::BytePointer_Impl__obj::set(_hx_tmp,null(),_hx_tmp1,null(),(index * (int)4));
HXLINE( 839)		return this->regDataPointer;
            	}
