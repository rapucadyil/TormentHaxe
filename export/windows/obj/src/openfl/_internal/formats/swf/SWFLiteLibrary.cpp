...
HX_DEFINE_STACK_FRAME(_hx_pos_34737d8619f6a20d_47_new,"openfl._internal.formats.swf.SWFLiteLibrary","new",0xe9e9b68b,"openfl._internal.formats.swf.SWFLiteLibrary.new","openfl/_internal/formats/swf/SWFLiteLibrary.hx",47,0x8efd6c01)
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_73_exists,"openfl._internal.formats.swf.SWFLiteLibrary","exists",0x64ea2491,"openfl._internal.formats.swf.SWFLiteLibrary.exists","openfl/_internal/formats/swf/SWFLiteLibrary.hx",73,0x8efd6c01)
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_94_getImage,"openfl._internal.formats.swf.SWFLiteLibrary","getImage",0x9de10cda,"openfl._internal.formats.swf.SWFLiteLibrary.getImage","openfl/_internal/formats/swf/SWFLiteLibrary.hx",94,0x8efd6c01)
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_140_getMovieClip,"openfl._internal.formats.swf.SWFLiteLibrary","getMovieClip",0x17711b9f,"openfl._internal.formats.swf.SWFLiteLibrary.getMovieClip","openfl/_internal/formats/swf/SWFLiteLibrary.hx",140,0x8efd6c01)
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_147_isLocal,"openfl._internal.formats.swf.SWFLiteLibrary","isLocal",0xd93244cc,"openfl._internal.formats.swf.SWFLiteLibrary.isLocal","openfl/_internal/formats/swf/SWFLiteLibrary.hx",147,0x8efd6c01)
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_190_load,"openfl._internal.formats.swf.SWFLiteLibrary","load",0xc14b199b,"openfl._internal.formats.swf.SWFLiteLibrary.load","openfl/_internal/formats/swf/SWFLiteLibrary.hx",190,0x8efd6c01)
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_163_load,"openfl._internal.formats.swf.SWFLiteLibrary","load",0xc14b199b,"openfl._internal.formats.swf.SWFLiteLibrary.load","openfl/_internal/formats/swf/SWFLiteLibrary.hx",163,0x8efd6c01)
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_152_load,"openfl._internal.formats.swf.SWFLiteLibrary","load",0xc14b199b,"openfl._internal.formats.swf.SWFLiteLibrary.load","openfl/_internal/formats/swf/SWFLiteLibrary.hx",152,0x8efd6c01)
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_232_load,"openfl._internal.formats.swf.SWFLiteLibrary","load",0xc14b199b,"openfl._internal.formats.swf.SWFLiteLibrary.load","openfl/_internal/formats/swf/SWFLiteLibrary.hx",232,0x8efd6c01)
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_233_load,"openfl._internal.formats.swf.SWFLiteLibrary","load",0xc14b199b,"openfl._internal.formats.swf.SWFLiteLibrary.load","openfl/_internal/formats/swf/SWFLiteLibrary.hx",233,0x8efd6c01)
...
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_267_loadImage,"openfl._internal.formats.swf.SWFLiteLibrary","loadImage",0xe4c1c3c0,"openfl._internal.formats.swf.SWFLiteLibrary.loadImage","openfl/_internal/formats/swf/SWFLiteLibrary.hx",267,0x8efd6c01)
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_296_unload,"openfl._internal.formats.swf.SWFLiteLibrary","unload",0x0a96a7b4,"openfl._internal.formats.swf.SWFLiteLibrary.unload","openfl/_internal/formats/swf/SWFLiteLibrary.hx",296,0x8efd6c01)
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_322___copyChannel,"openfl._internal.formats.swf.SWFLiteLibrary","__copyChannel",0x7aec2859,"openfl._internal.formats.swf.SWFLiteLibrary.__copyChannel","openfl/_internal/formats/swf/SWFLiteLibrary.hx",322,0x8efd6c01)
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_339___fromManifest,"openfl._internal.formats.swf.SWFLiteLibrary","__fromManifest",0x1d309e0e,"openfl._internal.formats.swf.SWFLiteLibrary.__fromManifest","openfl/_internal/formats/swf/SWFLiteLibrary.hx",339,0x8efd6c01)
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_357___load,"openfl._internal.formats.swf.SWFLiteLibrary","__load",0x9bba03fb,"openfl._internal.formats.swf.SWFLiteLibrary.__load","openfl/_internal/formats/swf/SWFLiteLibrary.hx",357,0x8efd6c01)
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_364___loadImage,"openfl._internal.formats.swf.SWFLiteLibrary","__loadImage",0x60453d60,"openfl._internal.formats.swf.SWFLiteLibrary.__loadImage","openfl/_internal/formats/swf/SWFLiteLibrary.hx",364,0x8efd6c01)
namespace openfl{
namespace _internal{
namespace formats{
namespace swf{
...
void SWFLiteLibrary_obj::__construct(::String id,::String uuid){
            	HX_GC_STACKFRAME(&_hx_pos_34737d8619f6a20d_47_new)
...
bool SWFLiteLibrary_obj::exists(::String id,::String type){
            	HX_STACKFRAME(&_hx_pos_34737d8619f6a20d_73_exists)
...
HXLINE(  89)		return false;
 ...
 ::lime::graphics::Image SWFLiteLibrary_obj::getImage(::String id){
            	HX_STACKFRAME(&_hx_pos_34737d8619f6a20d_94_getImage)
...
HXLINE( 133)		return this->super::getImage(id);
 ...
 ::openfl::display::MovieClip SWFLiteLibrary_obj::getMovieClip(::String id){
            	HX_STACKFRAME(&_hx_pos_34737d8619f6a20d_140_getMovieClip)
...
bool SWFLiteLibrary_obj::isLocal(::String id,::String type){
            	HX_STACKFRAME(&_hx_pos_34737d8619f6a20d_147_isLocal)
 ...
 ::lime::app::Future SWFLiteLibrary_obj::load(){
            		...
            		void _hx_run(::String data){
            			...
            			void _hx_run( ::lime::utils::AssetLibrary _){
            				HX_GC_STACKFRAME(&_hx_pos_34737d8619f6a20d_190_load)
HXLINE( 192)				_gthis->preloading = false;
HXLINE( 193)				promise->complete(_gthis);
            			}
            			HX_END_LOCAL_FUNC1((void))

            			HX_GC_STACKFRAME(&_hx_pos_34737d8619f6a20d_163_load)
HXLINE( 165)			_gthis->cachedText->set(_gthis->id,data);
HXLINE( 167)			_gthis->swf = ::openfl::_internal::formats::swf::SWFLite_obj::unserialize(data);
...
HXLINE( 188)			::openfl::_internal::formats::swf::SWFLite_obj::instances->set(_gthis->instanceID,_gthis->swf);
HXLINE( 190)			_gthis->_hx___load()->onProgress(promise->progress_dyn())->onError(promise->error_dyn())->onComplete( ::Dynamic(new _hx_Closure_0(_gthis,promise)));
            	...
            	HX_GC_STACKFRAME(&_hx_pos_34737d8619f6a20d_152_load)
HXDLIN( 152)		 ::openfl::_internal::formats::swf::SWFLiteLibrary _gthis = hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 209)			this->loadText(this->id)->onError(promise->error_dyn())->onComplete(onComplete);
            			...
            			void _hx_run( ::Dynamic _1){
            				HX_GC_STACKFRAME(&_hx_pos_34737d8619f6a20d_232_load)
HXLINE( 232)				onComplete(loader->data);
            			...
            			void _hx_run( ::Dynamic e){
            				HX_GC_STACKFRAME(&_hx_pos_34737d8619f6a20d_233_load)
...
HXDLIN( 243)		 ::openfl::_internal::formats::swf::SWFLiteLibrary _gthis = hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 261)					if (hx::IsNotNull( bitmapSymbol->alpha )) {
            						...
            						void _hx_run( ::lime::graphics::Image image){
            							...
            							void _hx_run( ::lime::graphics::Image alpha){
            								HX_GC_STACKFRAME(&_hx_pos_34737d8619f6a20d_267_loadImage)
...
void SWFLiteLibrary_obj::unload(){
            	HX_STACKFRAME(&_hx_pos_34737d8619f6a20d_296_unload)
HXLINE( 298)		if (hx::IsNull( this->swf )) {
HXLINE( 298)			return;
            		}
HXLINE( 300)		bool _hx_tmp;
HXDLIN( 300)		if (::openfl::_internal::formats::swf::SWFLite_obj::instances->exists(this->instanceID)) {
HXLINE( 300)			 ::openfl::_internal::formats::swf::SWFLite _hx_tmp1 = ::openfl::_internal::formats::swf::SWFLite_obj::instances->get(this->instanceID).StaticCast<  ::openfl::_internal::formats::swf::SWFLite >();
...
HXLINE( 302)			::openfl::_internal::formats::swf::SWFLite_obj::instances->remove(this->instanceID);
            		}
...
void SWFLiteLibrary_obj::_hx___copyChannel( ::lime::graphics::Image image, ::lime::graphics::Image alpha){
            	HX_GC_STACKFRAME(&_hx_pos_34737d8619f6a20d_322___copyChannel)
...
void SWFLiteLibrary_obj::_hx___fromManifest( ::lime::utils::AssetManifest manifest){
            	HX_STACKFRAME(&_hx_pos_34737d8619f6a20d_339___fromManifest)
...
HXLINE( 348)				 ::openfl::_internal::formats::swf::SWFLiteLibrary _hx_tmp = hx::ObjectPtr<OBJ_>(this);
...
HXDLIN( 348)				_hx_tmp->bytesTotal = (_hx_tmp1 + this->sizes->get(id1));
 ...
 ::lime::app::Future SWFLiteLibrary_obj::_hx___load(){
            	HX_STACKFRAME(&_hx_pos_34737d8619f6a20d_357___load)
...
HX_DEFINE_DYNAMIC_FUNC0(SWFLiteLibrary_obj,_hx___load,return )
 ...
 ::lime::app::Future SWFLiteLibrary_obj::_hx___loadImage(::String id){
            	HX_STACKFRAME(&_hx_pos_34737d8619f6a20d_364___loadImage)
