...
HX_LOCAL_STACK_FRAME(_hx_pos_8e0849c8e2179fab_50_dispose,"openfl.display3D.VertexBuffer3D","dispose",0x6b6860bf,"openfl.display3D.VertexBuffer3D.dispose","openfl/display3D/VertexBuffer3D.hx",50,0xb1ad396e)
...
HX_LOCAL_STACK_FRAME(_hx_pos_8e0849c8e2179fab_79_uploadFromVector,"openfl.display3D.VertexBuffer3D","uploadFromVector",0xcf228b0e,"openfl.display3D.VertexBuffer3D.uploadFromVector","openfl/display3D/VertexBuffer3D.hx",79,0xb1ad396e)
namespace openfl{
namespace display3D{
...
HXLINE(  41)		 ::lime::_internal::backend::native::NativeOpenGLRenderContext gl = this->_hx___context->gl;
HXLINE(  43)		this->_hx___id = gl->createBuffer();
HXLINE(  44)		this->_hx___stride = (this->_hx___vertexSize * (int)4);
HXLINE(  45)		int _hx_tmp;
HXDLIN(  45)		if (hx::IsEq( ::openfl::display3D::_Context3DBufferUsage::Context3DBufferUsage_Impl__obj::fromString(bufferUsage),(int)0 )) {
HXLINE(  45)			_hx_tmp = gl->DYNAMIC_DRAW;
            		}
            		else {
HXLINE(  45)			_hx_tmp = gl->STATIC_DRAW;
            		}
HXDLIN(  45)		this->_hx___usage = _hx_tmp;
            	}
...
HXDLIN(  63)		this->uploadFromTypedArray(this1,null());
            	}
...
HXLINE(  71)		 ::lime::_internal::backend::native::NativeOpenGLRenderContext gl = this->_hx___context->gl;
HXLINE(  73)		this->_hx___context->_hx___bindGLArrayBuffer(this->_hx___id);
HXLINE(  74)		::lime::graphics::_WebGLRenderContext::WebGLRenderContext_Impl__obj::bufferData(gl,gl->ARRAY_BUFFER,data,this->_hx___usage);
            	}
...
void VertexBuffer3D_obj::uploadFromVector( ::openfl::_Vector::FloatVector data,int startVertex,int numVertices){
            	HX_GC_STACKFRAME(&_hx_pos_8e0849c8e2179fab_79_uploadFromVector)
HXLINE(  81)		if (hx::IsNull( data )) {
HXLINE(  81)			return;
            		}
HXLINE(  82)		 ::lime::_internal::backend::native::NativeOpenGLRenderContext gl = this->_hx___context->gl;
HXLINE(  86)		int start = (startVertex * this->_hx___vertexSize);
HXLINE(  87)		int count = (numVertices * this->_hx___vertexSize);
HXLINE(  88)		int length = (start + count);
HXLINE(  90)		 ::lime::utils::ArrayBufferView existingFloat32Array = this->_hx___tempFloat32Array;
HXLINE(  92)		bool _hx_tmp;
HXDLIN(  92)		if (hx::IsNotNull( this->_hx___tempFloat32Array )) {
HXLINE(  92)			_hx_tmp = (this->_hx___tempFloat32Array->length < count);
            		}
            		else {
HXLINE(  92)			_hx_tmp = true;
            		}
HXDLIN(  92)		if (_hx_tmp) {
HXLINE(  94)			 ::lime::utils::ArrayBufferView this1;
HXDLIN(  94)			if (hx::IsNotNull( count )) {
HXLINE(  94)				this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,count,(int)8);
            			}
            			else {
HXLINE(  94)				HX_STACK_DO_THROW(HX_("Invalid constructor arguments for Float32Array",8e,c1,f4,d4));
            			}
HXDLIN(  94)			this->_hx___tempFloat32Array = this1;
HXLINE(  96)			if (hx::IsNotNull( existingFloat32Array )) {
HXLINE(  98)				 ::lime::utils::ArrayBufferView _this = this->_hx___tempFloat32Array;
HXDLIN(  98)				int offset = (int)0;
HXDLIN(  98)				if (hx::IsNotNull( existingFloat32Array )) {
HXLINE(  98)					 ::haxe::io::Bytes _this1 = _this->buffer;
HXDLIN(  98)					_this1->blit((offset * _this->bytesPerElement),existingFloat32Array->buffer,existingFloat32Array->byteOffset,existingFloat32Array->byteLength);
            				}
            				else {
HXLINE(  98)					HX_STACK_DO_THROW(HX_("Invalid .set call. either view, or array must be not-null.",64,ba,b7,6c));
            				}
            			}
            		}
HXLINE( 104)		{
HXLINE( 104)			int _g1 = start;
HXDLIN( 104)			int _g = length;
HXDLIN( 104)			while((_g1 < _g)){
HXLINE( 104)				_g1 = (_g1 + (int)1);
HXDLIN( 104)				int i = (_g1 - (int)1);
HXLINE( 106)				{
HXLINE( 106)					 ::lime::utils::ArrayBufferView this2 = this->_hx___tempFloat32Array;
HXDLIN( 106)					Float val = data->get(i);
HXDLIN( 106)					{
HXLINE( 106)						int this3 = this2->byteOffset;
HXDLIN( 106)						::__hxcpp_memory_set_float(this2->buffer->b,(this3 + ((i - start) * (int)4)),val);
            					}
            				}
            			}
            		}
HXLINE( 110)		this->uploadFromTypedArray(this->_hx___tempFloat32Array,null());
            	}
