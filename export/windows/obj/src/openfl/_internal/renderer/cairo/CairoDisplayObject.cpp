...
HXLINE(  24)		if (!(displayObject->_hx___renderable)) {
HXLINE(  24)			return;
            		}
HXLINE(  26)		Float alpha = renderer->_hx___getAlpha(displayObject->_hx___worldAlpha);
...
HXLINE(  29)			_hx_tmp3 = !(displayObject->_hx___isCacheBitmapRender);
            		}
            		else {
HXLINE(  29)			_hx_tmp3 = false;
            		}
HXDLIN(  29)		if (_hx_tmp3) {
HXLINE(  29)			_hx_tmp2 = (displayObject->get_width() > (int)0);
            		}
            		else {
HXLINE(  29)			_hx_tmp2 = false;
            		}
HXDLIN(  29)		if (_hx_tmp2) {
HXLINE(  29)			_hx_tmp1 = (displayObject->get_height() > (int)0);
            		}
            		else {
...
HXLINE(  39)			cairo->setSourceRGB(((Float)((int)hx::UShr(color,(int)16) & (int)(int)255) / (Float)(int)255),((Float)((int)hx::UShr(color,(int)8) & (int)(int)255) / (Float)(int)255),((Float)((int)color & (int)(int)255) / (Float)(int)255));
HXLINE(  40)			Float _hx_tmp4 = displayObject->get_width();
HXDLIN(  40)			cairo->rectangle((int)0,(int)0,_hx_tmp4,displayObject->get_height());
