...
HXLINE(1303)			::openfl::_internal::renderer::cairo::CairoGraphics_obj::cairo->setOperator((int)0);
HXLINE(1304)			::openfl::_internal::renderer::cairo::CairoGraphics_obj::cairo->paint();
HXLINE(1305)			::openfl::_internal::renderer::cairo::CairoGraphics_obj::cairo->setOperator((int)2);
