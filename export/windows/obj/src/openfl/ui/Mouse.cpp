...
HX_LOCAL_STACK_FRAME(_hx_pos_9dfd1f611dbbe53a_52_hide,"openfl.ui.Mouse","hide",0x974c7e47,"openfl.ui.Mouse.hide","openfl/ui/Mouse.hx",52,0xeac39ff5)
HX_LOCAL_STACK_FRAME(_hx_pos_9dfd1f611dbbe53a_76_show,"openfl.ui.Mouse","show",0x9e911e82,"openfl.ui.Mouse.show","openfl/ui/Mouse.hx",76,0xeac39ff5)
HX_LOCAL_STACK_FRAME(_hx_pos_9dfd1f611dbbe53a_99_get_cursor,"openfl.ui.Mouse","get_cursor",0xfdb1b9e4,"openfl.ui.Mouse.get_cursor","openfl/ui/Mouse.hx",99,0xeac39ff5)
HX_LOCAL_STACK_FRAME(_hx_pos_9dfd1f611dbbe53a_104_set_cursor,"openfl.ui.Mouse","set_cursor",0x012f5858,"openfl.ui.Mouse.set_cursor","openfl/ui/Mouse.hx",104,0xeac39ff5)
HX_LOCAL_STACK_FRAME(_hx_pos_9dfd1f611dbbe53a_28_boot,"openfl.ui.Mouse","boot",0x9359cdb7,"openfl.ui.Mouse.boot","openfl/ui/Mouse.hx",28,0xeac39ff5)
HX_LOCAL_STACK_FRAME(_hx_pos_9dfd1f611dbbe53a_29_boot,"openfl.ui.Mouse","boot",0x9359cdb7,"openfl.ui.Mouse.boot","openfl/ui/Mouse.hx",29,0xeac39ff5)
...
void Mouse_obj::hide(){
            	HX_STACKFRAME(&_hx_pos_9dfd1f611dbbe53a_52_hide)
HXLINE(  54)		::openfl::ui::Mouse_obj::_hx___hidden = true;
HXLINE(  56)		{
HXLINE(  56)			int _g = (int)0;
HXDLIN(  56)			::Array< ::Dynamic> _g1 = ::lime::app::Application_obj::current->_hx___windows;
HXDLIN(  56)			while((_g < _g1->length)){
HXLINE(  56)				 ::lime::ui::Window window = _g1->__get(_g).StaticCast<  ::lime::ui::Window >();
HXDLIN(  56)				_g = (_g + (int)1);
HXLINE(  58)				window->set_cursor(null());
            			}
            		}
            	}
...
void Mouse_obj::show(){
            	HX_STACKFRAME(&_hx_pos_9dfd1f611dbbe53a_76_show)
HXLINE(  78)		::openfl::ui::Mouse_obj::_hx___hidden = false;
HXLINE(  80)		::String cacheCursor = ::openfl::ui::Mouse_obj::_hx___cursor;
HXLINE(  81)		::openfl::ui::Mouse_obj::_hx___cursor = null();
HXLINE(  82)		::openfl::ui::Mouse_obj::set_cursor(cacheCursor);
            	}
...
::String Mouse_obj::get_cursor(){
            	HX_STACKFRAME(&_hx_pos_9dfd1f611dbbe53a_99_get_cursor)
HXDLIN(  99)		return ::openfl::ui::Mouse_obj::_hx___cursor;
            	}
...
::String Mouse_obj::set_cursor(::String value){
            	HX_STACKFRAME(&_hx_pos_9dfd1f611dbbe53a_104_set_cursor)
HXLINE( 106)		if (hx::IsNull( value )) {
HXLINE( 106)			value = HX_("auto",6f,df,76,40);
            		}
HXLINE( 107)		 ::lime::ui::MouseCursor setCursor = null();
HXLINE( 109)		::String _hx_switch_0 = value;
            		if (  (_hx_switch_0==HX_("arrow",c9,79,8f,25)) ){
HXLINE( 111)			setCursor = ::lime::ui::MouseCursor_obj::ARROW_dyn();
HXDLIN( 111)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("button",f2,61,e0,d9)) ){
HXLINE( 112)			setCursor = ::lime::ui::MouseCursor_obj::POINTER_dyn();
HXDLIN( 112)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("crosshair",a2,46,c8,8a)) ){
HXLINE( 115)			setCursor = ::lime::ui::MouseCursor_obj::CROSSHAIR_dyn();
HXDLIN( 115)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("custom",b1,87,92,3f)) ){
HXLINE( 116)			setCursor = ::lime::ui::MouseCursor_obj::CUSTOM_dyn();
HXDLIN( 116)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("hand",6f,2b,08,45)) ){
HXLINE( 113)			setCursor = ::lime::ui::MouseCursor_obj::MOVE_dyn();
HXDLIN( 113)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("ibeam",58,ca,26,b6)) ){
HXLINE( 114)			setCursor = ::lime::ui::MouseCursor_obj::TEXT_dyn();
HXDLIN( 114)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("resize_nesw",06,ae,e9,a7)) ){
HXLINE( 117)			setCursor = ::lime::ui::MouseCursor_obj::RESIZE_NESW_dyn();
HXDLIN( 117)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("resize_ns",f0,cc,f2,ab)) ){
HXLINE( 118)			setCursor = ::lime::ui::MouseCursor_obj::RESIZE_NS_dyn();
HXDLIN( 118)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("resize_nwse",86,56,f7,a7)) ){
HXLINE( 119)			setCursor = ::lime::ui::MouseCursor_obj::RESIZE_NWSE_dyn();
HXDLIN( 119)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("resize_we",b9,d4,f2,ab)) ){
HXLINE( 120)			setCursor = ::lime::ui::MouseCursor_obj::RESIZE_WE_dyn();
HXDLIN( 120)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("wait",75,5a,f2,4e)) ){
HXLINE( 121)			setCursor = ::lime::ui::MouseCursor_obj::WAIT_dyn();
HXDLIN( 121)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("waitarrow",34,17,98,4f)) ){
HXLINE( 122)			setCursor = ::lime::ui::MouseCursor_obj::WAIT_ARROW_dyn();
...
HXDLIN( 127)		if (hx::IsNotNull( setCursor )) {
HXLINE( 127)			_hx_tmp = !(::openfl::ui::Mouse_obj::_hx___hidden);
            		}
            		else {
HXLINE( 127)			_hx_tmp = false;
            		}
HXDLIN( 127)		if (_hx_tmp) {
HXLINE( 129)			int _g = (int)0;
HXDLIN( 129)			::Array< ::Dynamic> _g1 = ::lime::app::Application_obj::current->_hx___windows;
HXDLIN( 129)			while((_g < _g1->length)){
HXLINE( 129)				 ::lime::ui::Window window = _g1->__get(_g).StaticCast<  ::lime::ui::Window >();
HXDLIN( 129)				_g = (_g + (int)1);
HXLINE( 131)				window->set_cursor(setCursor);
            			}
            		}
HXLINE( 137)		return (::openfl::ui::Mouse_obj::_hx___cursor = value);
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_9dfd1f611dbbe53a_28_boot)
HXDLIN(  28)		supportsCursor = true;
            	}
{
            	HX_STACKFRAME(&_hx_pos_9dfd1f611dbbe53a_29_boot)
HXDLIN(  29)		supportsNativeCursor = true;
            	}
{
            	HX_STACKFRAME(&_hx_pos_9dfd1f611dbbe53a_31_boot)
HXDLIN(  31)		_hx___cursor = HX_("auto",6f,df,76,40);
            	}
}
