...
HX_DECLARE_STACK_FRAME(_hx_pos_cef4a471e9b9c478_929_new)
...
HXLINE( 931)		( ( ::lime::_internal::backend::native::KeyEventInfo)(__this) )->type = type;
HXLINE( 932)		( ( ::lime::_internal::backend::native::KeyEventInfo)(__this) )->windowID = windowID;
HXLINE( 933)		( ( ::lime::_internal::backend::native::KeyEventInfo)(__this) )->keyCode = keyCode;
HXLINE( 934)		( ( ::lime::_internal::backend::native::KeyEventInfo)(__this) )->modifier = modifier;
            	}
