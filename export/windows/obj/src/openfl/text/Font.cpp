...
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_198___fromLimeFont,"openfl.text.Font","__fromLimeFont",0x57c4282a,"openfl.text.Font.__fromLimeFont","openfl/text/Font.hx",198,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_203___initialize,"openfl.text.Font","__initialize",0x3f396f6c,"openfl.text.Font.__initialize","openfl/text/Font.hx",203,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_238_get_fontName,"openfl.text.Font","get_fontName",0x9a8206bf,"openfl.text.Font.get_fontName","openfl/text/Font.hx",238,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_245_set_fontName,"openfl.text.Font","set_fontName",0xaf7b2a33,"openfl.text.Font.set_fontName","openfl/text/Font.hx",245,0x076bbaac)
...
void Font_obj::_hx___fromLimeFont( ::lime::text::Font font){
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_198___fromLimeFont)
HXDLIN( 198)		this->_hx___copyFrom(font);
            	}
...
bool Font_obj::_hx___initialize(){
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_203___initialize)
HXLINE( 206)		if (!(this->_hx___initialized)) {
HXLINE( 208)			if (hx::IsNotNull( this->src )) {
HXLINE( 211)				if ((this->unitsPerEM == (int)0)) {
HXLINE( 211)					this->_hx___initializeSource();
            				}
HXLINE( 212)				this->_hx___initialized = true;
            			}
            			else {
HXLINE( 214)				bool _hx_tmp;
HXDLIN( 214)				bool _hx_tmp1;
HXDLIN( 214)				if (hx::IsNull( this->src )) {
HXLINE( 214)					_hx_tmp1 = hx::IsNotNull( this->_hx___fontID );
            				}
            				else {
HXLINE( 214)					_hx_tmp1 = false;
            				}
HXDLIN( 214)				if (_hx_tmp1) {
HXLINE( 214)					_hx_tmp = ::openfl::utils::Assets_obj::isLocal(this->_hx___fontID,null(),null());
            				}
            				else {
HXLINE( 214)					_hx_tmp = false;
            				}
HXDLIN( 214)				if (_hx_tmp) {
HXLINE( 216)					this->_hx___fromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toArrayBuffer(::openfl::utils::Assets_obj::getBytes(this->_hx___fontID)));
HXLINE( 217)					this->_hx___initialized = true;
            				}
            			}
            		}
HXLINE( 224)		return this->_hx___initialized;
            	}
...
::String Font_obj::get_fontName(){
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_238_get_fontName)
HXDLIN( 238)		return this->name;
            	}
...
::String Font_obj::set_fontName(::String value){
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_245_set_fontName)
HXDLIN( 245)		return (this->name = value);
            	}
...
HXLINE( 168)		 ::openfl::text::Font instance = null();
HXLINE( 170)		if (hx::IsNull( ::Type_obj::getClass(font) )) {
HXLINE( 172)			instance = hx::TCast<  ::openfl::text::Font >::cast(::Type_obj::createInstance(font,::cpp::VirtualArray_obj::__new(0)));
            		}
            		else {
HXLINE( 176)			instance = hx::TCast<  ::openfl::text::Font >::cast(font);
            		}
HXLINE( 180)		if (hx::IsNotNull( instance )) {
HXLINE( 188)			::openfl::text::Font_obj::_hx___registeredFonts->push(instance);
HXLINE( 189)			::openfl::text::Font_obj::_hx___fontByName->set(instance->name,instance);
            		}
            	}
