...
HX_DEFINE_STACK_FRAME(_hx_pos_b4e1347513889d4b_31_new,"openfl._internal.renderer.context3D.Context3DBuffer","new",0xe3fe3309,"openfl._internal.renderer.context3D.Context3DBuffer.new","openfl/_internal/renderer/context3D/Context3DBuffer.hx",31,0x815d61c7)
HX_LOCAL_STACK_FRAME(_hx_pos_b4e1347513889d4b_45_drawElements,"openfl._internal.renderer.context3D.Context3DBuffer","drawElements",0x23da4292,"openfl._internal.renderer.context3D.Context3DBuffer.drawElements","openfl/_internal/renderer/context3D/Context3DBuffer.hx",45,0x815d61c7)
HX_LOCAL_STACK_FRAME(_hx_pos_b4e1347513889d4b_86_flushVertexBufferData,"openfl._internal.renderer.context3D.Context3DBuffer","flushVertexBufferData",0x10028b9b,"openfl._internal.renderer.context3D.Context3DBuffer.flushVertexBufferData","openfl/_internal/renderer/context3D/Context3DBuffer.hx",86,0x815d61c7)
HX_LOCAL_STACK_FRAME(_hx_pos_b4e1347513889d4b_100_resize,"openfl._internal.renderer.context3D.Context3DBuffer","resize",0x81af46eb,"openfl._internal.renderer.context3D.Context3DBuffer.resize","openfl/_internal/renderer/context3D/Context3DBuffer.hx",100,0x815d61c7)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b4e1347513889d4b_15_boot,"openfl._internal.renderer.context3D.Context3DBuffer","boot",0x92877569,"openfl._internal.renderer.context3D.Context3DBuffer.boot","openfl/_internal/renderer/context3D/Context3DBuffer.hx",15,0x815d61c7)
HX_LOCAL_STACK_FRAME(_hx_pos_b4e1347513889d4b_16_boot,"openfl._internal.renderer.context3D.Context3DBuffer","boot",0x92877569,"openfl._internal.renderer.context3D.Context3DBuffer.boot","openfl/_internal/renderer/context3D/Context3DBuffer.hx",16,0x815d61c7)
namespace openfl{
namespace _internal{
namespace renderer{
namespace context3D{
...
void Context3DBuffer_obj::__construct( ::openfl::display3D::Context3D context3D, ::openfl::_internal::renderer::context3D::Context3DElementType elementType,int elementCount,int dataPerVertex){
            	HX_STACKFRAME(&_hx_pos_b4e1347513889d4b_31_new)
HXLINE(  33)		this->context3D = context3D;
HXLINE(  34)		this->elementType = elementType;
HXLINE(  35)		this->dataPerVertex = dataPerVertex;
HXLINE(  37)		this->indexCount = (int)0;
HXLINE(  38)		this->vertexCount = (int)0;
HXLINE(  40)		this->resize(elementCount,null());
            	}
...
int length = __o_length.Default(-1);
            	HX_STACKFRAME(&_hx_pos_b4e1347513889d4b_45_drawElements)
HXLINE(  47)		bool _hx_tmp;
HXDLIN(  47)		if ((this->indexCount != (int)0)) {
HXLINE(  47)			_hx_tmp = (this->vertexCount == (int)0);
            		}
            		else {
...
HXLINE(  49)		{
HXLINE(  49)			 ::openfl::_internal::renderer::context3D::Context3DElementType _g = this->elementType;
HXDLIN(  49)			if ((_hx_getEnumValueIndex(_g) == (int)0)) {
HXLINE(  53)				if ((length == (int)-1)) {
HXLINE(  53)					length = (this->elementCount * (int)2);
            				}
HXLINE(  55)				bool _hx_tmp1;
HXDLIN(  55)				if ((start < (int)10922)) {
HXLINE(  55)					_hx_tmp1 = ((length - start) < (int)10922);
            				}
            				else {
HXLINE(  55)					_hx_tmp1 = false;
            				}
HXDLIN(  55)				if (_hx_tmp1) {
HXLINE(  57)					 ::openfl::display3D::Context3D _hx_tmp2 = this->context3D;
HXDLIN(  57)					 ::openfl::display3D::IndexBuffer3D _hx_tmp3 = this->indexBuffers->__get((int)0).StaticCast<  ::openfl::display3D::IndexBuffer3D >();
HXDLIN(  57)					_hx_tmp2->drawTriangles(_hx_tmp3,(start * (int)2),(length * (int)2));
            				}
            				else {
HXLINE(  61)					int end = (start + length);
HXLINE(  63)					while((start < end)){
HXLINE(  65)						int arrayBufferIndex = ::Math_obj::floor(((Float)start / (Float)(int)10922));
HXLINE(  67)						length = ::Std_obj::_hx_int(::Math_obj::min((end - start),(int)10922));
HXLINE(  68)						if ((length <= (int)0)) {
HXLINE(  68)							goto _hx_goto_1;
            						}
HXLINE(  72)						 ::openfl::display3D::Context3D _hx_tmp4 = this->context3D;
HXDLIN(  72)						 ::openfl::display3D::IndexBuffer3D _hx_tmp5 = this->indexBuffers->__get(arrayBufferIndex).StaticCast<  ::openfl::display3D::IndexBuffer3D >();
HXDLIN(  72)						_hx_tmp4->drawTriangles(_hx_tmp5,((start - (arrayBufferIndex * (int)10922)) * (int)6),(length * (int)2));
HXLINE(  73)						start = (start + length);
            					}
            					_hx_goto_1:;
            				}
            			}
...
void Context3DBuffer_obj::flushVertexBufferData(){
            	HX_STACKFRAME(&_hx_pos_b4e1347513889d4b_86_flushVertexBufferData)
HXLINE(  88)		if ((this->vertexBufferData->length > this->vertexCount)) {
HXLINE(  90)			this->vertexCount = this->vertexBufferData->length;
HXLINE(  91)			this->vertexBuffer = this->context3D->createVertexBuffer(this->vertexCount,this->dataPerVertex,(int)0);
            		}
HXLINE(  95)		this->vertexBuffer->uploadFromTypedArray(this->vertexBufferData,null());
            	}
...
int dataPerVertex = __o_dataPerVertex.Default(-1);
            	HX_GC_STACKFRAME(&_hx_pos_b4e1347513889d4b_100_resize)
HXLINE( 102)		this->elementCount = elementCount;
HXLINE( 104)		if ((dataPerVertex == (int)-1)) {
HXLINE( 104)			dataPerVertex = this->dataPerVertex;
            		}
HXLINE( 106)		if ((dataPerVertex != this->dataPerVertex)) {
HXLINE( 108)			this->vertexBuffer = null();
HXLINE( 109)			this->vertexCount = (int)0;
HXLINE( 111)			this->dataPerVertex = dataPerVertex;
            		}
HXLINE( 115)		int numVertices = (int)0;
HXLINE( 117)		{
HXLINE( 117)			 ::openfl::_internal::renderer::context3D::Context3DElementType _g = this->elementType;
HXDLIN( 117)			switch((int)(_hx_getEnumValueIndex(_g))){
            				case (int)0: {
HXLINE( 121)					numVertices = (elementCount * (int)4);
            				}
            				break;
            				case (int)1: {
HXLINE( 125)					numVertices = (elementCount * (int)3);
            				}
            				break;
            				case (int)2: {
HXLINE( 130)					numVertices = (elementCount * (int)3);
            				}
            				break;
            			}
            		}
HXLINE( 136)		int vertexLength = (numVertices * dataPerVertex);
HXLINE( 138)		if (hx::IsNull( this->vertexBufferData )) {
HXLINE( 140)			 ::lime::utils::ArrayBufferView this1;
HXDLIN( 140)			if (hx::IsNotNull( vertexLength )) {
HXLINE( 140)				this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,vertexLength,(int)8);
            			}
            			else {
HXLINE( 140)				HX_STACK_DO_THROW(HX_("Invalid constructor arguments for Float32Array",8e,c1,f4,d4));
            			}
HXDLIN( 140)			this->vertexBufferData = this1;
            		}
            		else {
HXLINE( 142)			if ((vertexLength > this->vertexBufferData->length)) {
HXLINE( 144)				 ::lime::utils::ArrayBufferView cacheBufferData = this->vertexBufferData;
HXLINE( 145)				 ::lime::utils::ArrayBufferView this2;
HXDLIN( 145)				if (hx::IsNotNull( vertexLength )) {
HXLINE( 145)					this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,vertexLength,(int)8);
            				}
            				else {
HXLINE( 145)					HX_STACK_DO_THROW(HX_("Invalid constructor arguments for Float32Array",8e,c1,f4,d4));
            				}
HXDLIN( 145)				this->vertexBufferData = this2;
HXLINE( 146)				{
HXLINE( 146)					 ::lime::utils::ArrayBufferView _this = this->vertexBufferData;
HXDLIN( 146)					int offset = (int)0;
HXDLIN( 146)					if (hx::IsNotNull( cacheBufferData )) {
HXLINE( 146)						 ::haxe::io::Bytes _this1 = _this->buffer;
HXDLIN( 146)						_this1->blit((offset * _this->bytesPerElement),cacheBufferData->buffer,cacheBufferData->byteOffset,cacheBufferData->byteLength);
            					}
            					else {
HXLINE( 146)						HX_STACK_DO_THROW(HX_("Invalid .set call. either view, or array must be not-null.",64,ba,b7,6c));
            					}
            				}
            			}
            		}
...
HXDLIN(  14)		MAX_INDEX_BUFFER_LENGTH = (int)65535;
            	}
{
            	HX_STACKFRAME(&_hx_pos_b4e1347513889d4b_15_boot)
HXDLIN(  15)		MAX_QUADS_PER_INDEX_BUFFER = (int)10922;
            	}
{
            	HX_STACKFRAME(&_hx_pos_b4e1347513889d4b_16_boot)
HXDLIN(  16)		MAX_QUAD_INDEX_BUFFER_LENGTH = (int)65532;
            	}
}
