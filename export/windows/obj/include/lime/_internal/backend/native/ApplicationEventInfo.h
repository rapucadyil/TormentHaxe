...
HX_DECLARE_STACK_FRAME(_hx_pos_1a94701d58bd3d3e_744_new)
...
HXLINE( 746)		( ( ::lime::_internal::backend::native::ApplicationEventInfo)(__this) )->type = type;
HXLINE( 747)		( ( ::lime::_internal::backend::native::ApplicationEventInfo)(__this) )->deltaTime = deltaTime;
            	}
