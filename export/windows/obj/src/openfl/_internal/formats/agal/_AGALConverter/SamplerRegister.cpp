...
HX_DEFINE_STACK_FRAME(_hx_pos_0f667a7c675195ce_964_new,"openfl._internal.formats.agal._AGALConverter.SamplerRegister","new",0xe06db1fa,"openfl._internal.formats.agal._AGALConverter.SamplerRegister.new","openfl/_internal/formats/agal/AGALConverter.hx",964,0x323dd368)
HX_LOCAL_STACK_FRAME(_hx_pos_0f667a7c675195ce_989_toGLSL,"openfl._internal.formats.agal._AGALConverter.SamplerRegister","toGLSL",0x0e5bf39f,"openfl._internal.formats.agal._AGALConverter.SamplerRegister.toGLSL","openfl/_internal/formats/agal/AGALConverter.hx",989,0x323dd368)
HX_LOCAL_STACK_FRAME(_hx_pos_0f667a7c675195ce_997_toSamplerState,"openfl._internal.formats.agal._AGALConverter.SamplerRegister","toSamplerState",0x99da12aa,"openfl._internal.formats.agal._AGALConverter.SamplerRegister.toSamplerState","openfl/_internal/formats/agal/AGALConverter.hx",997,0x323dd368)
HX_LOCAL_STACK_FRAME(_hx_pos_0f667a7c675195ce_971_parse,"openfl._internal.formats.agal._AGALConverter.SamplerRegister","parse",0x40de8c4d,"openfl._internal.formats.agal._AGALConverter.SamplerRegister.parse","openfl/_internal/formats/agal/AGALConverter.hx",971,0x323dd368)
namespace openfl{
namespace _internal{
namespace formats{
namespace agal{
...
void SamplerRegister_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_0f667a7c675195ce_964_new)
            	}
...
::String SamplerRegister_obj::toGLSL(){
            	HX_STACKFRAME(&_hx_pos_0f667a7c675195ce_989_toGLSL)
HXLINE( 991)		::String str = ::openfl::_internal::formats::agal::AGALConverter_obj::prefixFromType(this->type,this->programType);
HXDLIN( 991)		::String str1 = (str + this->n);
HXLINE( 992)		return str1;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SamplerRegister_obj,toGLSL,return )
 ...
 ::openfl::_internal::renderer::SamplerState SamplerRegister_obj::toSamplerState(){
            	HX_GC_STACKFRAME(&_hx_pos_0f667a7c675195ce_997_toSamplerState)
HXLINE( 999)		 ::Dynamic wrap;
HXLINE(1000)		 ::Dynamic filter;
HXLINE(1001)		 ::Dynamic mipfilter;
HXLINE(1006)		{
HXLINE(1006)			int _g = this->f;
HXDLIN(1006)			switch((int)(_g)){
            				case (int)0: {
HXLINE(1007)					filter = (int)5;
            				}
            				break;
            				case (int)1: {
HXLINE(1008)					filter = (int)4;
            				}
            				break;
            				default:{
HXLINE(1009)					HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,null()));
            				}
            			}
            		}
HXLINE(1013)		{
HXLINE(1013)			int _g1 = this->m;
HXDLIN(1013)			switch((int)(_g1)){
            				case (int)0: {
HXLINE(1015)					mipfilter = (int)2;
            				}
            				break;
            				case (int)1: {
HXLINE(1017)					mipfilter = (int)1;
            				}
            				break;
            				case (int)2: {
HXLINE(1019)					mipfilter = (int)0;
            				}
            				break;
            				default:{
HXLINE(1020)					HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,null()));
            				}
            			}
            		}
HXLINE(1026)		{
HXLINE(1026)			int _g2 = this->w;
HXDLIN(1026)			switch((int)(_g2)){
            				case (int)0: {
HXLINE(1027)					wrap = (int)0;
            				}
            				break;
            				case (int)1: {
HXLINE(1028)					wrap = (int)2;
            				}
            				break;
            				default:{
HXLINE(1029)					HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,null()));
            				}
            			}
            		}
HXLINE(1032)		bool ignoreSampler = (((int)this->s & (int)(int)4) == (int)4);
HXLINE(1033)		bool centroid = (((int)this->s & (int)(int)1) == (int)1);
HXLINE(1034)		bool textureAlpha = (this->t == (int)2);
HXLINE(1037)		Float lodBias = ((Float)((int)((int)this->b << (int)(int)24) >> (int)(int)24) / (Float)((Float)8.0));
HXLINE(1039)		return  ::openfl::_internal::renderer::SamplerState_obj::__alloc( HX_CTX ,wrap,filter,mipfilter,lodBias,ignoreSampler,centroid,textureAlpha);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SamplerRegister_obj,toSamplerState,return )
 ...
 ::openfl::_internal::formats::agal::_AGALConverter::SamplerRegister SamplerRegister_obj::parse( cpp::Int64Struct v, ::openfl::_internal::formats::agal::_AGALConverter::ProgramType programType){
            	HX_GC_STACKFRAME(&_hx_pos_0f667a7c675195ce_971_parse)
HXLINE( 973)		 ::openfl::_internal::formats::agal::_AGALConverter::SamplerRegister sr =  ::openfl::_internal::formats::agal::_AGALConverter::SamplerRegister_obj::__alloc( HX_CTX );
HXLINE( 974)		sr->programType = programType;
HXLINE( 975)		 cpp::Int64Struct a = _hx_int64_shr(v,(int)60);
HXDLIN( 975)		sr->f = _hx_int64_low(_hx_int64_and(a,( ::cpp::Int64Struct((int)15))));
HXLINE( 976)		 cpp::Int64Struct a1 = _hx_int64_shr(v,(int)56);
HXDLIN( 976)		sr->m = _hx_int64_low(_hx_int64_and(a1,( ::cpp::Int64Struct((int)15))));
HXLINE( 977)		 cpp::Int64Struct a2 = _hx_int64_shr(v,(int)52);
HXDLIN( 977)		sr->w = _hx_int64_low(_hx_int64_and(a2,( ::cpp::Int64Struct((int)15))));
HXLINE( 978)		 cpp::Int64Struct a3 = _hx_int64_shr(v,(int)48);
HXDLIN( 978)		sr->s = _hx_int64_low(_hx_int64_and(a3,( ::cpp::Int64Struct((int)15))));
HXLINE( 979)		 cpp::Int64Struct a4 = _hx_int64_shr(v,(int)44);
HXDLIN( 979)		sr->d = _hx_int64_low(_hx_int64_and(a4,( ::cpp::Int64Struct((int)15))));
HXLINE( 980)		 cpp::Int64Struct a5 = _hx_int64_shr(v,(int)40);
HXDLIN( 980)		sr->t = _hx_int64_low(_hx_int64_and(a5,( ::cpp::Int64Struct((int)15))));
HXLINE( 981)		 cpp::Int64Struct a6 = _hx_int64_shr(v,(int)32);
HXDLIN( 981)		sr->type = _hx_int64_low(_hx_int64_and(a6,( ::cpp::Int64Struct((int)15))));
HXLINE( 982)		 cpp::Int64Struct a7 = _hx_int64_shr(v,(int)16);
HXDLIN( 982)		sr->b = _hx_int64_low(_hx_int64_and(a7,( ::cpp::Int64Struct((int)255))));
HXLINE( 983)		sr->n = _hx_int64_low(_hx_int64_and(v,( ::cpp::Int64Struct((int)65535))));
HXLINE( 984)		return sr;
            	}
