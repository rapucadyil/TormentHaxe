...
HX_DECLARE_STACK_FRAME(_hx_pos_a21879e7650910f2_807_new)
...
HXLINE( 809)		( ( ::lime::_internal::backend::native::DropEventInfo)(__this) )->type = type;
HXLINE( 810)		( ( ::lime::_internal::backend::native::DropEventInfo)(__this) )->file = file;
            	}
