...
HX_DEFINE_STACK_FRAME(_hx_pos_dd5cdbe7a8b93fcc_339_new,"openfl.utils.ByteArrayData","new",0x36383a32,"openfl.utils.ByteArrayData.new","openfl/utils/ByteArray.hx",339,0xaa5cee4a)
...
HX_LOCAL_STACK_FRAME(_hx_pos_dd5cdbe7a8b93fcc_790_writeBoolean,"openfl.utils.ByteArrayData","writeBoolean",0x790a5b77,"openfl.utils.ByteArrayData.writeBoolean","openfl/utils/ByteArray.hx",790,0xaa5cee4a)
HX_LOCAL_STACK_FRAME(_hx_pos_dd5cdbe7a8b93fcc_795_writeByte,"openfl.utils.ByteArrayData","writeByte",0x6d0ba6d9,"openfl.utils.ByteArrayData.writeByte","openfl/utils/ByteArray.hx",795,0xaa5cee4a)
HX_LOCAL_STACK_FRAME(_hx_pos_dd5cdbe7a8b93fcc_803_writeBytes,"openfl.utils.ByteArrayData","writeBytes",0xfd26577a,"openfl.utils.ByteArrayData.writeBytes","openfl/utils/ByteArray.hx",803,0xaa5cee4a)
HX_LOCAL_STACK_FRAME(_hx_pos_dd5cdbe7a8b93fcc_816_writeDouble,"openfl.utils.ByteArrayData","writeDouble",0x8fc20922,"openfl.utils.ByteArrayData.writeDouble","openfl/utils/ByteArray.hx",816,0xaa5cee4a)
HX_LOCAL_STACK_FRAME(_hx_pos_dd5cdbe7a8b93fcc_837_writeFloat,"openfl.utils.ByteArrayData","writeFloat",0x422514ab,"openfl.utils.ByteArrayData.writeFloat","openfl/utils/ByteArray.hx",837,0xaa5cee4a)
HX_LOCAL_STACK_FRAME(_hx_pos_dd5cdbe7a8b93fcc_853_writeInt,"openfl.utils.ByteArrayData","writeInt",0x83612a3e,"openfl.utils.ByteArrayData.writeInt","openfl/utils/ByteArray.hx",853,0xaa5cee4a)
HX_LOCAL_STACK_FRAME(_hx_pos_dd5cdbe7a8b93fcc_878_writeMultiByte,"openfl.utils.ByteArrayData","writeMultiByte",0xebbf88b0,"openfl.utils.ByteArrayData.writeMultiByte","openfl/utils/ByteArray.hx",878,0xaa5cee4a)
HX_LOCAL_STACK_FRAME(_hx_pos_dd5cdbe7a8b93fcc_885_writeObject,"openfl.utils.ByteArrayData","writeObject",0x72365cd0,"openfl.utils.ByteArrayData.writeObject","openfl/utils/ByteArray.hx",885,0xaa5cee4a)
HX_LOCAL_STACK_FRAME(_hx_pos_dd5cdbe7a8b93fcc_925_writeShort,"openfl.utils.ByteArrayData","writeShort",0xbbb5d38b,"openfl.utils.ByteArrayData.writeShort","openfl/utils/ByteArray.hx",925,0xaa5cee4a)
HX_LOCAL_STACK_FRAME(_hx_pos_dd5cdbe7a8b93fcc_946_writeUnsignedInt,"openfl.utils.ByteArrayData","writeUnsignedInt",0xcb6d2f49,"openfl.utils.ByteArrayData.writeUnsignedInt","openfl/utils/ByteArray.hx",946,0xaa5cee4a)
HX_LOCAL_STACK_FRAME(_hx_pos_dd5cdbe7a8b93fcc_951_writeUTF,"openfl.utils.ByteArrayData","writeUTF",0x836a2e76,"openfl.utils.ByteArrayData.writeUTF","openfl/utils/ByteArray.hx",951,0xaa5cee4a)
HX_LOCAL_STACK_FRAME(_hx_pos_dd5cdbe7a8b93fcc_961_writeUTFBytes,"openfl.utils.ByteArrayData","writeUTFBytes",0xc5d11e15,"openfl.utils.ByteArrayData.writeUTFBytes","openfl/utils/ByteArray.hx",961,0xaa5cee4a)
HX_LOCAL_STACK_FRAME(_hx_pos_dd5cdbe7a8b93fcc_969___fromBytes,"openfl.utils.ByteArrayData","__fromBytes",0x684ac753,"openfl.utils.ByteArrayData.__fromBytes","openfl/utils/ByteArray.hx",969,0xaa5cee4a)
HX_LOCAL_STACK_FRAME(_hx_pos_dd5cdbe7a8b93fcc_977___resize,"openfl.utils.ByteArrayData","__resize",0x101b8202,"openfl.utils.ByteArrayData.__resize","openfl/utils/ByteArray.hx",977,0xaa5cee4a)
HX_LOCAL_STACK_FRAME(_hx_pos_dd5cdbe7a8b93fcc_1008___setData,"openfl.utils.ByteArrayData","__setData",0xac6a7b1e,"openfl.utils.ByteArrayData.__setData","openfl/utils/ByteArray.hx",1008,0xaa5cee4a)
HX_LOCAL_STACK_FRAME(_hx_pos_dd5cdbe7a8b93fcc_1037_get_bytesAvailable,"openfl.utils.ByteArrayData","get_bytesAvailable",0x68329f15,"openfl.utils.ByteArrayData.get_bytesAvailable","openfl/utils/ByteArray.hx",1037,0xaa5cee4a)
HX_LOCAL_STACK_FRAME(_hx_pos_dd5cdbe7a8b93fcc_1044_get_endian,"openfl.utils.ByteArrayData","get_endian",0x95dc5cd2,"openfl.utils.ByteArrayData.get_endian","openfl/utils/ByteArray.hx",1044,0xaa5cee4a)
HX_LOCAL_STACK_FRAME(_hx_pos_dd5cdbe7a8b93fcc_1051_set_endian,"openfl.utils.ByteArrayData","set_endian",0x9959fb46,"openfl.utils.ByteArrayData.set_endian","openfl/utils/ByteArray.hx",1051,0xaa5cee4a)
...
HX_LOCAL_STACK_FRAME(_hx_pos_dd5cdbe7a8b93fcc_315_boot,"openfl.utils.ByteArrayData","boot",0x3313b220,"openfl.utils.ByteArrayData.boot","openfl/utils/ByteArray.hx",315,0xaa5cee4a)
namespace openfl{
namespace utils{

void ByteArrayData_obj::__construct(hx::Null< int >  __o_length){
int length = __o_length.Default(0);
            	HX_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_339_new)
HXLINE( 341)		 ::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::alloc(length);
HXLINE( 344)		if ((length > (int)0)) {
HXLINE( 346)			bytes->fill((int)0,length,(int)0);
            		}
...
HXLINE( 417)		 ::haxe::io::Bytes limeBytes = hx::ObjectPtr<OBJ_>(this);
HXLINE( 419)		 ::haxe::io::Bytes bytes;
HXDLIN( 419)		 ::Dynamic _hx_switch_0 = algorithm;
            		if (  (_hx_switch_0==(int)0) ){
HXLINE( 419)			bytes = ::lime::utils::_Bytes::Bytes_Impl__obj::compress(limeBytes,::lime::utils::CompressionAlgorithm_obj::DEFLATE_dyn());
HXDLIN( 419)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==(int)1) ){
HXLINE( 419)			bytes = ::lime::utils::_Bytes::Bytes_Impl__obj::compress(limeBytes,::lime::utils::CompressionAlgorithm_obj::LZMA_dyn());
HXDLIN( 419)			goto _hx_goto_2;
            		}
            		/* default */{
HXLINE( 419)			bytes = ::lime::utils::_Bytes::Bytes_Impl__obj::compress(limeBytes,::lime::utils::CompressionAlgorithm_obj::ZLIB_dyn());
            		}
            		_hx_goto_2:;
...
HXLINE( 470)			HX_STACK_DO_THROW( ::openfl::errors::EOFError_obj::__alloc( HX_CTX ,null(),null()));
            		}
...
HXLINE( 501)			HX_STACK_DO_THROW( ::openfl::errors::EOFError_obj::__alloc( HX_CTX ,null(),null()));
            		}
...
HXLINE( 523)				HX_STACK_DO_THROW( ::openfl::errors::EOFError_obj::__alloc( HX_CTX ,null(),null()));
            			}
...
HXLINE( 549)				HX_STACK_DO_THROW( ::openfl::errors::EOFError_obj::__alloc( HX_CTX ,null(),null()));
            			}
...
HXLINE( 673)			HX_STACK_DO_THROW( ::openfl::errors::EOFError_obj::__alloc( HX_CTX ,null(),null()));
            		}
...
HXLINE( 731)			HX_STACK_DO_THROW( ::openfl::errors::EOFError_obj::__alloc( HX_CTX ,null(),null()));
            		}
HXLINE( 735)		 ::openfl::utils::ByteArrayData _hx_tmp = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 735)		_hx_tmp->position = (_hx_tmp->position + length);
HXLINE( 737)		return this->getString((this->position - length),length,null());
            	}
...
HXLINE( 765)		 ::haxe::io::Bytes limeBytes = hx::ObjectPtr<OBJ_>(this);
HXLINE( 767)		 ::haxe::io::Bytes bytes;
HXDLIN( 767)		 ::Dynamic _hx_switch_0 = algorithm;
            		if (  (_hx_switch_0==(int)0) ){
HXLINE( 767)			bytes = ::lime::utils::_Bytes::Bytes_Impl__obj::decompress(limeBytes,::lime::utils::CompressionAlgorithm_obj::DEFLATE_dyn());
HXDLIN( 767)			goto _hx_goto_20;
            		}
            		if (  (_hx_switch_0==(int)1) ){
HXLINE( 767)			bytes = ::lime::utils::_Bytes::Bytes_Impl__obj::decompress(limeBytes,::lime::utils::CompressionAlgorithm_obj::LZMA_dyn());
HXDLIN( 767)			goto _hx_goto_20;
            		}
            		/* default */{
HXLINE( 767)			bytes = ::lime::utils::_Bytes::Bytes_Impl__obj::decompress(limeBytes,::lime::utils::CompressionAlgorithm_obj::ZLIB_dyn());
            		}
            		_hx_goto_20:;
HXLINE( 775)		if (hx::IsNotNull( bytes )) {
HXLINE( 777)			{
HXLINE( 777)				this->b = bytes->b;
HXDLIN( 777)				this->__length = bytes->length;
            			}
HXLINE( 779)			this->length = this->__length;
            		}
HXLINE( 783)		this->position = (int)0;
            	}
...
void ByteArrayData_obj::writeBoolean(bool value){
            	HX_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_790_writeBoolean)
HXDLIN( 790)		int _hx_tmp;
HXDLIN( 790)		if (value) {
HXDLIN( 790)			_hx_tmp = (int)1;
            		}
            		else {
HXDLIN( 790)			_hx_tmp = (int)0;
            		}
HXDLIN( 790)		this->writeByte(_hx_tmp);
            	}
...
void ByteArrayData_obj::writeByte(int value){
            	HX_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_795_writeByte)
HXLINE( 797)		this->_hx___resize((this->position + (int)1));
HXLINE( 798)		{
HXLINE( 798)			::Array< unsigned char > _hx_tmp = this->b;
HXDLIN( 798)			_hx_tmp[this->position++] = ((int)value & (int)(int)255);
            		}
            	}
...
int offset = __o_offset.Default(0);
int length = __o_length.Default(0);
            	HX_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_803_writeBytes)
HXLINE( 805)		if ((::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(bytes) == (int)0)) {
HXLINE( 805)			return;
            		}
HXLINE( 806)		if ((length == (int)0)) {
HXLINE( 806)			length = (::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(bytes) - offset);
            		}
HXLINE( 808)		this->_hx___resize((this->position + length));
HXLINE( 809)		this->blit(this->position,bytes,offset,length);
HXLINE( 811)		this->position = (this->position + length);
            	}
...
void ByteArrayData_obj::writeDouble(Float value){
            	HX_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_816_writeDouble)
HXLINE( 818)		 cpp::Int64Struct int64 = ::haxe::io::FPHelper_obj::doubleToI64(value);
HXLINE( 820)		if (hx::IsEq( this->_hx___endian,(int)1 )) {
HXLINE( 822)			this->writeInt(_hx_int64_low(int64));
HXLINE( 823)			this->writeInt(_hx_int64_high(int64));
            		}
            		else {
HXLINE( 827)			this->writeInt(_hx_int64_high(int64));
HXLINE( 828)			this->writeInt(_hx_int64_low(int64));
            		}
            	}
...
void ByteArrayData_obj::writeFloat(Float value){
            	HX_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_837_writeFloat)
HXDLIN( 837)		if (hx::IsEq( this->_hx___endian,(int)1 )) {
HXLINE( 839)			this->_hx___resize((this->position + (int)4));
HXLINE( 840)			this->setFloat(this->position,value);
HXLINE( 841)			 ::openfl::utils::ByteArrayData _hx_tmp = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 841)			_hx_tmp->position = (_hx_tmp->position + (int)4);
            		}
            		else {
HXLINE( 845)			int _hx_int = ::haxe::io::FPHelper_obj::floatToI32(value);
HXLINE( 846)			this->writeInt(_hx_int);
            		}
            	}
...
void ByteArrayData_obj::writeInt(int value){
            	HX_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_853_writeInt)
HXLINE( 855)		this->_hx___resize((this->position + (int)4));
HXLINE( 857)		if (hx::IsEq( this->_hx___endian,(int)1 )) {
HXLINE( 859)			{
HXLINE( 859)				::Array< unsigned char > _hx_tmp = this->b;
HXDLIN( 859)				_hx_tmp[this->position++] = ((int)value & (int)(int)255);
            			}
HXLINE( 860)			{
HXLINE( 860)				::Array< unsigned char > _hx_tmp1 = this->b;
HXDLIN( 860)				_hx_tmp1[this->position++] = ((int)((int)value >> (int)(int)8) & (int)(int)255);
            			}
HXLINE( 861)			{
HXLINE( 861)				::Array< unsigned char > _hx_tmp2 = this->b;
HXDLIN( 861)				_hx_tmp2[this->position++] = ((int)((int)value >> (int)(int)16) & (int)(int)255);
            			}
HXLINE( 862)			{
HXLINE( 862)				::Array< unsigned char > _hx_tmp3 = this->b;
HXDLIN( 862)				_hx_tmp3[this->position++] = ((int)((int)value >> (int)(int)24) & (int)(int)255);
            			}
            		}
            		else {
HXLINE( 866)			{
HXLINE( 866)				::Array< unsigned char > _hx_tmp4 = this->b;
HXDLIN( 866)				_hx_tmp4[this->position++] = ((int)((int)value >> (int)(int)24) & (int)(int)255);
            			}
HXLINE( 867)			{
HXLINE( 867)				::Array< unsigned char > _hx_tmp5 = this->b;
HXDLIN( 867)				_hx_tmp5[this->position++] = ((int)((int)value >> (int)(int)16) & (int)(int)255);
            			}
HXLINE( 868)			{
HXLINE( 868)				::Array< unsigned char > _hx_tmp6 = this->b;
HXDLIN( 868)				_hx_tmp6[this->position++] = ((int)((int)value >> (int)(int)8) & (int)(int)255);
            			}
HXLINE( 869)			{
HXLINE( 869)				::Array< unsigned char > _hx_tmp7 = this->b;
HXDLIN( 869)				_hx_tmp7[this->position++] = ((int)value & (int)(int)255);
            			}
            		}
            	}
...
void ByteArrayData_obj::writeMultiByte(::String value,::String charSet){
            	HX_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_878_writeMultiByte)
HXDLIN( 878)		this->writeUTFBytes(value);
            	}
...
void ByteArrayData_obj::writeObject( ::Dynamic object){
            	HX_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_885_writeObject)
HXDLIN( 885)		int _g = this->objectEncoding;
HXDLIN( 885)		switch((int)(_g)){
            			case (int)10: {
HXLINE( 908)				::String value = ::haxe::Serializer_obj::run(object);
HXLINE( 909)				this->writeUTF(value);
            			}
            			break;
            			case (int)12: {
HXLINE( 913)				::String value1 = ::haxe::format::JsonPrinter_obj::print(object,null(),null());
HXLINE( 914)				this->writeUTF(value1);
            			}
            			break;
            			default:{
HXLINE( 918)				return;
...
void ByteArrayData_obj::writeShort(int value){
            	HX_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_925_writeShort)
HXLINE( 927)		this->_hx___resize((this->position + (int)2));
HXLINE( 929)		if (hx::IsEq( this->_hx___endian,(int)1 )) {
HXLINE( 931)			this->b[this->position++] = value;
HXLINE( 932)			{
HXLINE( 932)				::Array< unsigned char > _hx_tmp = this->b;
HXDLIN( 932)				_hx_tmp[this->position++] = ((int)value >> (int)(int)8);
            			}
            		}
            		else {
HXLINE( 936)			{
HXLINE( 936)				::Array< unsigned char > _hx_tmp1 = this->b;
HXDLIN( 936)				_hx_tmp1[this->position++] = ((int)value >> (int)(int)8);
            			}
HXLINE( 937)			this->b[this->position++] = value;
            		}
            	}
...
void ByteArrayData_obj::writeUnsignedInt(int value){
            	HX_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_946_writeUnsignedInt)
HXDLIN( 946)		this->writeInt(value);
            	}
...
void ByteArrayData_obj::writeUTF(::String value){
            	HX_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_951_writeUTF)
HXLINE( 953)		 ::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::ofString(value,null());
HXLINE( 955)		this->writeShort(bytes->length);
HXLINE( 956)		this->writeBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromArrayBuffer(bytes),null(),null());
            	}
...
void ByteArrayData_obj::writeUTFBytes(::String value){
            	HX_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_961_writeUTFBytes)
HXLINE( 963)		 ::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::ofString(value,null());
HXLINE( 964)		this->writeBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromArrayBuffer(::haxe::io::Bytes_obj::ofString(value,null())),null(),null());
            	}
...
void ByteArrayData_obj::_hx___fromBytes( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_969___fromBytes)
HXLINE( 971)		{
HXLINE( 971)			this->b = bytes->b;
HXDLIN( 971)			this->__length = bytes->length;
            		}
HXLINE( 972)		this->length = bytes->length;
            	}
...
void ByteArrayData_obj::_hx___resize(int size){
            	HX_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_977___resize)
HXLINE( 979)		if ((size > this->__length)) {
HXLINE( 981)			 ::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::alloc(((int)((size + (int)1) * (int)3) >> (int)(int)1));
HXLINE( 983)			bytes->fill(this->length,size,(int)0);
HXLINE( 986)			if ((this->__length > (int)0)) {
HXLINE( 988)				int cacheLength = this->length;
HXLINE( 989)				this->length = this->__length;
HXLINE( 990)				bytes->blit((int)0,hx::ObjectPtr<OBJ_>(this),(int)0,this->__length);
HXLINE( 991)				this->length = cacheLength;
            			}
HXLINE( 995)			{
HXLINE( 995)				this->b = bytes->b;
HXDLIN( 995)				this->__length = bytes->length;
            			}
            		}
HXLINE( 999)		if ((this->length < size)) {
HXLINE(1001)			this->length = size;
            		}
            	}
...
void ByteArrayData_obj::_hx___setData( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_1008___setData)
HXLINE(1016)		this->b = bytes->b;
HXLINE(1019)		this->__length = bytes->length;
            	}
...
int ByteArrayData_obj::get_bytesAvailable(){
            	HX_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_1037_get_bytesAvailable)
HXDLIN(1037)		return (this->length - this->position);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ByteArrayData_obj,get_bytesAvailable,return )
 ...
 ::Dynamic ByteArrayData_obj::get_endian(){
            	HX_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_1044_get_endian)
HXDLIN(1044)		return this->_hx___endian;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ByteArrayData_obj,get_endian,return )
 ...
 ::Dynamic ByteArrayData_obj::set_endian( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_1051_set_endian)
HXDLIN(1051)		return (this->_hx___endian = value);
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_315_boot)
HXDLIN( 315)		_hx___defaultEndian = null();
            	}
}
