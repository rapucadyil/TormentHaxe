...
HX_LOCAL_STACK_FRAME(_hx_pos_f5857023424199a6_363_get_bitmapData,"openfl.display.Bitmap","get_bitmapData",0x619f7ef7,"openfl.display.Bitmap.get_bitmapData","openfl/display/Bitmap.hx",363,0x461b2743)
HX_LOCAL_STACK_FRAME(_hx_pos_f5857023424199a6_368_set_bitmapData,"openfl.display.Bitmap","set_bitmapData",0x81bf676b,"openfl.display.Bitmap.set_bitmapData","openfl/display/Bitmap.hx",368,0x461b2743)
HX_LOCAL_STACK_FRAME(_hx_pos_f5857023424199a6_388_get_height,"openfl.display.Bitmap","get_height",0x5901da25,"openfl.display.Bitmap.get_height","openfl/display/Bitmap.hx",388,0x461b2743)
HX_LOCAL_STACK_FRAME(_hx_pos_f5857023424199a6_401_set_height,"openfl.display.Bitmap","set_height",0x5c7f7899,"openfl.display.Bitmap.set_height","openfl/display/Bitmap.hx",401,0x461b2743)
HX_LOCAL_STACK_FRAME(_hx_pos_f5857023424199a6_421_get_width,"openfl.display.Bitmap","get_width",0x2b347588,"openfl.display.Bitmap.get_width","openfl/display/Bitmap.hx",421,0x461b2743)
HX_LOCAL_STACK_FRAME(_hx_pos_f5857023424199a6_434_set_width,"openfl.display.Bitmap","set_width",0x0e856194,"openfl.display.Bitmap.set_width","openfl/display/Bitmap.hx",434,0x461b2743)
namespace openfl{
namespace display{
...
HXLINE( 147)			 ::openfl::geom::Rectangle bounds = ::openfl::geom::Rectangle_obj::_hx___pool->get();
...
HXDLIN( 327)						 ::openfl::geom::Rectangle rect = ::openfl::geom::Rectangle_obj::_hx___pool->get();
...
HXDLIN( 348)		if (hx::IsNotNull( this->_hx___bitmapData )) {
HXLINE( 348)			bool _hx_tmp1;
HXDLIN( 348)			if (hx::IsNull( this->_hx___filters )) {
HXLINE( 348)				_hx_tmp1 = (renderer->_hx___type == HX_("opengl",6f,64,94,21));
            			}
            			else {
HXLINE( 348)				_hx_tmp1 = false;
            			}
HXDLIN( 348)			if (_hx_tmp1) {
HXLINE( 348)				_hx_tmp = hx::IsNull( this->_hx___cacheBitmap );
            			}
            			else {
...
HXDLIN( 349)		if (hx::IsNotNull( this->_hx___bitmapData->image )) {
HXLINE( 349)			_hx_tmp2 = (this->_hx___bitmapData->image->version != this->_hx___imageVersion);
            		}
            		else {
HXLINE( 349)			_hx_tmp2 = false;
            		}
HXDLIN( 349)		return this->super::_hx___updateCacheBitmap(renderer,_hx_tmp2);
            	}


 ::openfl::display::BitmapData Bitmap_obj::get_bitmapData(){
            	HX_STACKFRAME(&_hx_pos_f5857023424199a6_363_get_bitmapData)
HXDLIN( 363)		return this->_hx___bitmapData;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Bitmap_obj,get_bitmapData,return )
 ...
 ::openfl::display::BitmapData Bitmap_obj::set_bitmapData( ::openfl::display::BitmapData value){
            	HX_STACKFRAME(&_hx_pos_f5857023424199a6_368_set_bitmapData)
HXLINE( 370)		this->_hx___bitmapData = value;
HXLINE( 371)		this->smoothing = false;
HXLINE( 373)		if (!(this->_hx___renderDirty)) {
HXLINE( 373)			this->_hx___renderDirty = true;
HXDLIN( 373)			this->_hx___setParentRenderDirty();
            		}
HXLINE( 375)		bool _hx_tmp = hx::IsNotNull( this->_hx___filters );
HXLINE( 381)		this->_hx___imageVersion = (int)-1;
HXLINE( 383)		return this->_hx___bitmapData;
            	}
...
Float Bitmap_obj::get_height(){
            	HX_STACKFRAME(&_hx_pos_f5857023424199a6_388_get_height)
HXLINE( 390)		if (hx::IsNotNull( this->_hx___bitmapData )) {
HXLINE( 392)			int _hx_tmp = this->_hx___bitmapData->height;
HXDLIN( 392)			return (_hx_tmp * ::Math_obj::abs(this->get_scaleY()));
            		}
...
Float Bitmap_obj::set_height(Float value){
            	HX_STACKFRAME(&_hx_pos_f5857023424199a6_401_set_height)
HXLINE( 403)		if (hx::IsNotNull( this->_hx___bitmapData )) {
HXLINE( 405)			if ((value != this->_hx___bitmapData->height)) {
HXLINE( 407)				if (!(this->_hx___renderDirty)) {
HXLINE( 407)					this->_hx___renderDirty = true;
HXDLIN( 407)					this->_hx___setParentRenderDirty();
            				}
HXLINE( 408)				this->set_scaleY(((Float)value / (Float)this->_hx___bitmapData->height));
            			}
...
Float Bitmap_obj::get_width(){
            	HX_STACKFRAME(&_hx_pos_f5857023424199a6_421_get_width)
HXLINE( 423)		if (hx::IsNotNull( this->_hx___bitmapData )) {
HXLINE( 425)			int _hx_tmp = this->_hx___bitmapData->width;
HXDLIN( 425)			return (_hx_tmp * ::Math_obj::abs(this->_hx___scaleX));
            		}
...
Float Bitmap_obj::set_width(Float value){
            	HX_STACKFRAME(&_hx_pos_f5857023424199a6_434_set_width)
HXLINE( 436)		if (hx::IsNotNull( this->_hx___bitmapData )) {
HXLINE( 438)			if ((value != this->_hx___bitmapData->width)) {
HXLINE( 440)				if (!(this->_hx___renderDirty)) {
HXLINE( 440)					this->_hx___renderDirty = true;
HXDLIN( 440)					this->_hx___setParentRenderDirty();
            				}
HXLINE( 441)				this->set_scaleX(((Float)value / (Float)this->_hx___bitmapData->width));
            			}
