...
HX_DEFINE_STACK_FRAME(_hx_pos_485718db96d0565f_871_new,"openfl.display3D.UniformMap","new",0x9f6fba13,"openfl.display3D.UniformMap.new","openfl/display3D/Program3D.hx",871,0x0a985b04)
HX_DEFINE_STACK_FRAME(_hx_pos_485718db96d0565f_865_new,"openfl.display3D.UniformMap","new",0x9f6fba13,"openfl.display3D.UniformMap.new","openfl/display3D/Program3D.hx",865,0x0a985b04)
HX_LOCAL_STACK_FRAME(_hx_pos_485718db96d0565f_906_flush,"openfl.display3D.UniformMap","flush",0x8fcb5f37,"openfl.display3D.UniformMap.flush","openfl/display3D/Program3D.hx",906,0x0a985b04)
HX_LOCAL_STACK_FRAME(_hx_pos_485718db96d0565f_926_markAllDirty,"openfl.display3D.UniformMap","markAllDirty",0xabef284b,"openfl.display3D.UniformMap.markAllDirty","openfl/display3D/Program3D.hx",926,0x0a985b04)
HX_LOCAL_STACK_FRAME(_hx_pos_485718db96d0565f_934_markDirty,"openfl.display3D.UniformMap","markDirty",0xb895e2b8,"openfl.display3D.UniformMap.markDirty","openfl/display3D/Program3D.hx",934,0x0a985b04)
namespace openfl{
namespace display3D{
...
void UniformMap_obj::__construct(::Array< ::Dynamic> list){
            		...
            		int _hx_run( ::openfl::display3D::Uniform a, ::openfl::display3D::Uniform b){
            			HX_STACKFRAME(&_hx_pos_485718db96d0565f_871_new)
HXLINE( 871)			return ::Reflect_obj::compare(a->regIndex,b->regIndex);
            		}
            		HX_END_LOCAL_FUNC2(return)

            	HX_GC_STACKFRAME(&_hx_pos_485718db96d0565f_865_new)
HXLINE( 867)		this->_hx___uniforms = list;
HXLINE( 869)		this->_hx___uniforms->sort( ::Dynamic(new _hx_Closure_0()));
HXLINE( 875)		int total = (int)0;
HXLINE( 877)		{
HXLINE( 877)			int _g = (int)0;
HXDLIN( 877)			::Array< ::Dynamic> _g1 = this->_hx___uniforms;
HXDLIN( 877)			while((_g < _g1->length)){
HXLINE( 877)				 ::openfl::display3D::Uniform uniform = _g1->__get(_g).StaticCast<  ::openfl::display3D::Uniform >();
HXDLIN( 877)				_g = (_g + (int)1);
HXLINE( 879)				if (((uniform->regIndex + uniform->regCount) > total)) {
HXLINE( 881)					total = (uniform->regIndex + uniform->regCount);
            				}
            			}
            		}
HXLINE( 887)		bool fixed = null();
HXDLIN( 887)		this->_hx___registerLookup =  ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,total,fixed,null(),true);
HXLINE( 889)		{
HXLINE( 889)			int _g2 = (int)0;
HXDLIN( 889)			::Array< ::Dynamic> _g11 = this->_hx___uniforms;
HXDLIN( 889)			while((_g2 < _g11->length)){
HXLINE( 889)				 ::openfl::display3D::Uniform uniform1 = _g11->__get(_g2).StaticCast<  ::openfl::display3D::Uniform >();
HXDLIN( 889)				_g2 = (_g2 + (int)1);
HXLINE( 891)				{
HXLINE( 891)					int _g3 = (int)0;
HXDLIN( 891)					int _g21 = uniform1->regCount;
HXDLIN( 891)					while((_g3 < _g21)){
HXLINE( 891)						_g3 = (_g3 + (int)1);
HXDLIN( 891)						int i = (_g3 - (int)1);
HXLINE( 893)						this->_hx___registerLookup->set((uniform1->regIndex + i),uniform1).StaticCast<  ::openfl::display3D::Uniform >();
            					}
            				}
            			}
            		}
HXLINE( 899)		this->_hx___anyDirty = (this->_hx___allDirty = true);
            	}
...
void UniformMap_obj::flush(){
            	HX_STACKFRAME(&_hx_pos_485718db96d0565f_906_flush)
HXDLIN( 906)		if (this->_hx___anyDirty) {
HXLINE( 908)			{
HXLINE( 908)				int _g = (int)0;
HXDLIN( 908)				::Array< ::Dynamic> _g1 = this->_hx___uniforms;
HXDLIN( 908)				while((_g < _g1->length)){
HXLINE( 908)					 ::openfl::display3D::Uniform uniform = _g1->__get(_g).StaticCast<  ::openfl::display3D::Uniform >();
HXDLIN( 908)					_g = (_g + (int)1);
HXLINE( 910)					bool _hx_tmp;
HXDLIN( 910)					if (!(this->_hx___allDirty)) {
HXLINE( 910)						_hx_tmp = uniform->isDirty;
            					}
            					else {
HXLINE( 910)						_hx_tmp = true;
            					}
HXDLIN( 910)					if (_hx_tmp) {
HXLINE( 912)						uniform->flush();
HXLINE( 913)						uniform->isDirty = false;
            					}
            				}
            			}
HXLINE( 919)			this->_hx___anyDirty = (this->_hx___allDirty = false);
            		}
            	}
...
void UniformMap_obj::markAllDirty(){
            	HX_STACKFRAME(&_hx_pos_485718db96d0565f_926_markAllDirty)
HXLINE( 928)		this->_hx___allDirty = true;
HXLINE( 929)		this->_hx___anyDirty = true;
            	}
...
void UniformMap_obj::markDirty(int start,int count){
            	HX_STACKFRAME(&_hx_pos_485718db96d0565f_934_markDirty)
HXLINE( 936)		if (this->_hx___allDirty) {
HXLINE( 938)			return;
            		}
HXLINE( 942)		int end = (start + count);
HXLINE( 944)		if ((end > this->_hx___registerLookup->get_length())) {
HXLINE( 946)			end = this->_hx___registerLookup->get_length();
            		}
HXLINE( 950)		int index = start;
HXLINE( 952)		while((index < end)){
HXLINE( 954)			 ::openfl::display3D::Uniform uniform = this->_hx___registerLookup->get(index).StaticCast<  ::openfl::display3D::Uniform >();
HXLINE( 956)			if (hx::IsNotNull( uniform )) {
HXLINE( 958)				uniform->isDirty = true;
HXLINE( 959)				this->_hx___anyDirty = true;
HXLINE( 961)				index = (uniform->regIndex + uniform->regCount);
            			}
            			else {
HXLINE( 965)				index = (index + (int)1);
            			}
            		}
            	}
