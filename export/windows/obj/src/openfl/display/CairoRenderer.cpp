...
HX_LOCAL_STACK_FRAME(_hx_pos_765a23aeaf3cad17_188___setBlendMode,"openfl.display.CairoRenderer","__setBlendMode",0x010a21ff,"openfl.display.CairoRenderer.__setBlendMode","openfl/display/CairoRenderer.hx",188,0x013a831f)
namespace openfl{
namespace display{
...
void CairoRenderer_obj::_hx___setBlendMode( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_765a23aeaf3cad17_188___setBlendMode)
HXLINE( 190)		if (hx::IsNotNull( this->_hx___overrideBlendMode )) {
HXLINE( 190)			value = this->_hx___overrideBlendMode;
            		}
HXLINE( 191)		if (hx::IsEq( this->_hx___blendMode,value )) {
HXLINE( 191)			return;
            		}
HXLINE( 193)		this->_hx___blendMode = value;
HXLINE( 195)		 ::Dynamic _hx_switch_0 = value;
            		if (  (_hx_switch_0==(int)0) ){
HXLINE( 199)			this->cairo->setOperator((int)12);
HXDLIN( 199)			goto _hx_goto_10;
            		}
            		if (  (_hx_switch_0==(int)2) ){
HXLINE( 207)			this->cairo->setOperator((int)17);
HXDLIN( 207)			goto _hx_goto_10;
            		}
            		if (  (_hx_switch_0==(int)3) ){
HXLINE( 211)			this->cairo->setOperator((int)23);
HXDLIN( 211)			goto _hx_goto_10;
            		}
            		if (  (_hx_switch_0==(int)5) ){
HXLINE( 219)			this->cairo->setOperator((int)21);
HXDLIN( 219)			goto _hx_goto_10;
            		}
            		if (  (_hx_switch_0==(int)7) ){
HXLINE( 227)			this->cairo->setOperator((int)2);
HXDLIN( 227)			goto _hx_goto_10;
            		}
            		if (  (_hx_switch_0==(int)8) ){
HXLINE( 231)			this->cairo->setOperator((int)18);
HXDLIN( 231)			goto _hx_goto_10;
            		}
            		if (  (_hx_switch_0==(int)9) ){
HXLINE( 235)			this->cairo->setOperator((int)14);
HXDLIN( 235)			goto _hx_goto_10;
            		}
            		if (  (_hx_switch_0==(int)11) ){
HXLINE( 239)			this->cairo->setOperator((int)16);
HXDLIN( 239)			goto _hx_goto_10;
            		}
            		if (  (_hx_switch_0==(int)12) ){
HXLINE( 243)			this->cairo->setOperator((int)15);
HXDLIN( 243)			goto _hx_goto_10;
            		}
            		/* default */{
HXLINE( 255)			this->cairo->setOperator((int)2);
            		}
            		_hx_goto_10:;
            	}
