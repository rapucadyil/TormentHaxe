...
HX_DEFINE_STACK_FRAME(_hx_pos_c312f67fa56a379a_1067_new,"openfl._internal.formats.agal._AGALConverter.SourceRegister","new",0xbda55cf3,"openfl._internal.formats.agal._AGALConverter.SourceRegister.new","openfl/_internal/formats/agal/AGALConverter.hx",1067,0x323dd368)
HX_LOCAL_STACK_FRAME(_hx_pos_c312f67fa56a379a_1091_toGLSL,"openfl._internal.formats.agal._AGALConverter.SourceRegister","toGLSL",0x1060aa46,"openfl._internal.formats.agal._AGALConverter.SourceRegister.toGLSL","openfl/_internal/formats/agal/AGALConverter.hx",1091,0x323dd368)
HX_LOCAL_STACK_FRAME(_hx_pos_c312f67fa56a379a_1074_parse,"openfl._internal.formats.agal._AGALConverter.SourceRegister","parse",0x9b91a786,"openfl._internal.formats.agal._AGALConverter.SourceRegister.parse","openfl/_internal/formats/agal/AGALConverter.hx",1074,0x323dd368)
namespace openfl{
namespace _internal{
namespace formats{
namespace agal{
...
void SourceRegister_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_c312f67fa56a379a_1067_new)
            	}
...
int offset = __o_offset.Default(0);
            	HX_STACKFRAME(&_hx_pos_c312f67fa56a379a_1091_toGLSL)
HXLINE(1093)		if ((this->type == (int)3)) {
HXLINE(1095)			if (hx::IsEq( this->programType,::openfl::_internal::formats::agal::_AGALConverter::ProgramType_obj::VERTEX_dyn() )) {
HXLINE(1095)				return HX_("gl_Position",63,0d,2a,e5);
            			}
            			else {
HXLINE(1095)				return HX_("gl_FragColor",d7,68,e4,21);
            			}
            		}
HXLINE(1099)		bool fullxyzw;
HXDLIN(1099)		if ((this->s == (int)228)) {
HXLINE(1099)			fullxyzw = (this->sourceMask == (int)15);
            		}
            		else {
HXLINE(1099)			fullxyzw = false;
            		}
HXLINE(1100)		::String swizzle = HX_("",00,00,00,00);
HXLINE(1102)		bool _hx_tmp;
HXDLIN(1102)		if ((this->type != (int)5)) {
HXLINE(1102)			_hx_tmp = !(fullxyzw);
            		}
            		else {
HXLINE(1102)			_hx_tmp = false;
            		}
HXDLIN(1102)		if (_hx_tmp) {
HXLINE(1104)			int _g = (int)0;
HXDLIN(1104)			while((_g < (int)4)){
HXLINE(1104)				_g = (_g + (int)1);
HXDLIN(1104)				int i = (_g - (int)1);
HXLINE(1107)				int _hx_tmp1 = this->sourceMask;
HXDLIN(1107)				if ((((int)_hx_tmp1 & (int)((int)(int)1 << (int)i)) != (int)0)) {
HXLINE(1109)					int _g1 = this->s;
HXDLIN(1109)					int _g11 = ((int)((int)_g1 >> (int)(i * (int)2)) & (int)(int)3);
HXDLIN(1109)					switch((int)(_g11)){
            						case (int)0: {
HXLINE(1111)							swizzle = (swizzle + HX_("x",78,00,00,00));
            						}
            						break;
            						case (int)1: {
HXLINE(1112)							swizzle = (swizzle + HX_("y",79,00,00,00));
            						}
            						break;
            						case (int)2: {
HXLINE(1113)							swizzle = (swizzle + HX_("z",7a,00,00,00));
            						}
            						break;
            						case (int)3: {
HXLINE(1114)							swizzle = (swizzle + HX_("w",77,00,00,00));
            						}
            						break;
            					}
            				}
...
HXLINE(1124)		::String str = ::openfl::_internal::formats::agal::AGALConverter_obj::prefixFromType(this->type,this->programType);
HXLINE(1126)		if ((this->d == (int)0)) {
HXLINE(1129)			str = (str + (this->n + offset));
            		}
            		else {
HXLINE(1134)			str = (str + this->o);
HXLINE(1135)			 ::Dynamic indexComponent = HX_("x",78,00,00,00).charCodeAt((int)0);
HXDLIN(1135)			::String indexComponent1 = ::String::fromCharCode((indexComponent + this->q));
HXLINE(1136)			::String indexRegister = ::openfl::_internal::formats::agal::AGALConverter_obj::prefixFromType(this->itype,this->programType);
HXDLIN(1136)			::String indexRegister1 = (((indexRegister + this->n) + HX_(".",2e,00,00,00)) + indexComponent1);
HXLINE(1137)			str = (str + ((((HX_("[ int(",3e,aa,07,15) + indexRegister1) + HX_(") +",74,38,1f,00)) + offset) + HX_("]",5d,00,00,00)));
            		}
HXLINE(1141)		bool _hx_tmp2;
HXDLIN(1141)		if (emitSwizzle) {
HXLINE(1141)			_hx_tmp2 = (swizzle != HX_("",00,00,00,00));
            		}
            		else {
HXLINE(1141)			_hx_tmp2 = false;
            		}
HXDLIN(1141)		if (_hx_tmp2) {
HXLINE(1143)			str = (str + (HX_(".",2e,00,00,00) + swizzle));
            		}
HXLINE(1147)		return str;
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(SourceRegister_obj,toGLSL,return )
 ...
 ::openfl::_internal::formats::agal::_AGALConverter::SourceRegister SourceRegister_obj::parse( cpp::Int64Struct v, ::openfl::_internal::formats::agal::_AGALConverter::ProgramType programType,int sourceMask){
            	HX_GC_STACKFRAME(&_hx_pos_c312f67fa56a379a_1074_parse)
HXLINE(1076)		 ::openfl::_internal::formats::agal::_AGALConverter::SourceRegister sr =  ::openfl::_internal::formats::agal::_AGALConverter::SourceRegister_obj::__alloc( HX_CTX );
HXLINE(1077)		sr->programType = programType;
HXLINE(1078)		 cpp::Int64Struct a = _hx_int64_shr(v,(int)63);
HXDLIN(1078)		sr->d = _hx_int64_low(_hx_int64_and(a,( ::cpp::Int64Struct((int)1))));
HXLINE(1079)		 cpp::Int64Struct a1 = _hx_int64_shr(v,(int)48);
HXDLIN(1079)		sr->q = _hx_int64_low(_hx_int64_and(a1,( ::cpp::Int64Struct((int)3))));
HXLINE(1080)		 cpp::Int64Struct a2 = _hx_int64_shr(v,(int)40);
HXDLIN(1080)		sr->itype = _hx_int64_low(_hx_int64_and(a2,( ::cpp::Int64Struct((int)15))));
HXLINE(1081)		 cpp::Int64Struct a3 = _hx_int64_shr(v,(int)32);
HXDLIN(1081)		sr->type = _hx_int64_low(_hx_int64_and(a3,( ::cpp::Int64Struct((int)15))));
HXLINE(1082)		 cpp::Int64Struct a4 = _hx_int64_shr(v,(int)24);
HXDLIN(1082)		sr->s = _hx_int64_low(_hx_int64_and(a4,( ::cpp::Int64Struct((int)255))));
HXLINE(1083)		 cpp::Int64Struct a5 = _hx_int64_shr(v,(int)16);
HXDLIN(1083)		sr->o = _hx_int64_low(_hx_int64_and(a5,( ::cpp::Int64Struct((int)255))));
HXLINE(1084)		sr->n = _hx_int64_low(_hx_int64_and(v,( ::cpp::Int64Struct((int)65535))));
HXLINE(1085)		sr->sourceMask = sourceMask;
HXLINE(1086)		return sr;
            	}
