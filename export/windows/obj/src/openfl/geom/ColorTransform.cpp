...
HX_DEFINE_STACK_FRAME(_hx_pos_82e72dbfef9da50a_163_new,"openfl.geom.ColorTransform","new",0x35d8b8af,"openfl.geom.ColorTransform.new","openfl/geom/ColorTransform.hx",163,0x850de941)
...
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_205_toString,"openfl.geom.ColorTransform","toString",0xe65269fd,"openfl.geom.ColorTransform.toString","openfl/geom/ColorTransform.hx",205,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_212___clone,"openfl.geom.ColorTransform","__clone",0x6d82280c,"openfl.geom.ColorTransform.__clone","openfl/geom/ColorTransform.hx",212,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_217___copyFrom,"openfl.geom.ColorTransform","__copyFrom",0x0c92ce70,"openfl.geom.ColorTransform.__copyFrom","openfl/geom/ColorTransform.hx",217,0x850de941)
...
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_247___identity,"openfl.geom.ColorTransform","__identity",0xfd6107ef,"openfl.geom.ColorTransform.__identity","openfl/geom/ColorTransform.hx",247,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_261___invert,"openfl.geom.ColorTransform","__invert",0xf5ebeb87,"openfl.geom.ColorTransform.__invert","openfl/geom/ColorTransform.hx",261,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_277___equals,"openfl.geom.ColorTransform","__equals",0x1605f2b0,"openfl.geom.ColorTransform.__equals","openfl/geom/ColorTransform.hx",277,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_284___isDefault,"openfl.geom.ColorTransform","__isDefault",0x071aee26,"openfl.geom.ColorTransform.__isDefault","openfl/geom/ColorTransform.hx",284,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_299___setArrays,"openfl.geom.ColorTransform","__setArrays",0x7ef0862b,"openfl.geom.ColorTransform.__setArrays","openfl/geom/ColorTransform.hx",299,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_322_get_color,"openfl.geom.ColorTransform","get_color",0x07485b49,"openfl.geom.ColorTransform.get_color","openfl/geom/ColorTransform.hx",322,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_327_set_color,"openfl.geom.ColorTransform","set_color",0xea994755,"openfl.geom.ColorTransform.set_color","openfl/geom/ColorTransform.hx",327,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_342___toLimeColorMatrix,"openfl.geom.ColorTransform","__toLimeColorMatrix",0x55c98ae3,"openfl.geom.ColorTransform.__toLimeColorMatrix","openfl/geom/ColorTransform.hx",342,0x850de941)
...
Float alphaOffset = __o_alphaOffset.Default(0);
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_163_new)
...
HXLINE( 190)		this->redOffset = ((second->redOffset * this->redMultiplier) + this->redOffset);
HXLINE( 191)		this->greenOffset = ((second->greenOffset * this->greenMultiplier) + this->greenOffset);
HXLINE( 192)		this->blueOffset = ((second->blueOffset * this->blueMultiplier) + this->blueOffset);
HXLINE( 193)		this->alphaOffset = ((second->alphaOffset * this->alphaMultiplier) + this->alphaOffset);
HXLINE( 195)		 ::openfl::geom::ColorTransform _hx_tmp = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 195)		_hx_tmp->redMultiplier = (_hx_tmp->redMultiplier * second->redMultiplier);
HXLINE( 196)		 ::openfl::geom::ColorTransform _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 196)		_hx_tmp1->greenMultiplier = (_hx_tmp1->greenMultiplier * second->greenMultiplier);
HXLINE( 197)		 ::openfl::geom::ColorTransform _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 197)		_hx_tmp2->blueMultiplier = (_hx_tmp2->blueMultiplier * second->blueMultiplier);
HXLINE( 198)		 ::openfl::geom::ColorTransform _hx_tmp3 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 198)		_hx_tmp3->alphaMultiplier = (_hx_tmp3->alphaMultiplier * second->alphaMultiplier);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ColorTransform_obj,toString,return )
 ...
 ::openfl::geom::ColorTransform ColorTransform_obj::_hx___clone(){
            	HX_GC_STACKFRAME(&_hx_pos_82e72dbfef9da50a_212___clone)
HXDLIN( 212)		return  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,this->redMultiplier,this->greenMultiplier,this->blueMultiplier,this->alphaMultiplier,this->redOffset,this->greenOffset,this->blueOffset,this->alphaOffset);
            	}
...
void ColorTransform_obj::_hx___copyFrom( ::openfl::geom::ColorTransform ct){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_217___copyFrom)
...
HXLINE( 234)		 ::openfl::geom::ColorTransform _hx_tmp = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 234)		_hx_tmp->redMultiplier = (_hx_tmp->redMultiplier * ct->redMultiplier);
HXLINE( 235)		 ::openfl::geom::ColorTransform _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 235)		_hx_tmp1->greenMultiplier = (_hx_tmp1->greenMultiplier * ct->greenMultiplier);
HXLINE( 236)		 ::openfl::geom::ColorTransform _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 236)		_hx_tmp2->blueMultiplier = (_hx_tmp2->blueMultiplier * ct->blueMultiplier);
HXLINE( 237)		 ::openfl::geom::ColorTransform _hx_tmp3 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 237)		_hx_tmp3->alphaMultiplier = (_hx_tmp3->alphaMultiplier * ct->alphaMultiplier);
HXLINE( 239)		 ::openfl::geom::ColorTransform _hx_tmp4 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 239)		_hx_tmp4->redOffset = (_hx_tmp4->redOffset + ct->redOffset);
HXLINE( 240)		 ::openfl::geom::ColorTransform _hx_tmp5 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 240)		_hx_tmp5->greenOffset = (_hx_tmp5->greenOffset + ct->greenOffset);
HXLINE( 241)		 ::openfl::geom::ColorTransform _hx_tmp6 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 241)		_hx_tmp6->blueOffset = (_hx_tmp6->blueOffset + ct->blueOffset);
HXLINE( 242)		 ::openfl::geom::ColorTransform _hx_tmp7 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 242)		_hx_tmp7->alphaOffset = (_hx_tmp7->alphaOffset + ct->alphaOffset);
            	}
...
void ColorTransform_obj::_hx___identity(){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_247___identity)
HXLINE( 249)		this->redMultiplier = (int)1;
HXLINE( 250)		this->greenMultiplier = (int)1;
HXLINE( 251)		this->blueMultiplier = (int)1;
HXLINE( 252)		this->alphaMultiplier = (int)1;
HXLINE( 253)		this->redOffset = (int)0;
HXLINE( 254)		this->greenOffset = (int)0;
HXLINE( 255)		this->blueOffset = (int)0;
HXLINE( 256)		this->alphaOffset = (int)0;
            	}
...
void ColorTransform_obj::_hx___invert(){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_261___invert)
HXLINE( 263)		this->redMultiplier = ((Float)(int)1 / (Float)this->redMultiplier);
HXLINE( 264)		this->greenMultiplier = ((Float)(int)1 / (Float)this->greenMultiplier);
HXLINE( 265)		this->blueMultiplier = ((Float)(int)1 / (Float)this->blueMultiplier);
HXLINE( 266)		this->alphaMultiplier = ((Float)(int)1 / (Float)this->alphaMultiplier);
HXLINE( 267)		this->redOffset = -(this->redOffset);
HXLINE( 268)		this->greenOffset = -(this->greenOffset);
HXLINE( 269)		this->blueOffset = -(this->blueOffset);
HXLINE( 270)		this->alphaOffset = -(this->alphaOffset);
            	}
...
bool ColorTransform_obj::_hx___equals( ::openfl::geom::ColorTransform ct,bool ignoreAlphaMultiplier){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_277___equals)
...
HXDLIN( 277)		if (hx::IsNotNull( ct )) {
HXDLIN( 277)			_hx_tmp6 = (this->redMultiplier == ct->redMultiplier);
            		}
            		else {
HXDLIN( 277)			_hx_tmp6 = false;
            		}
HXDLIN( 277)		if (_hx_tmp6) {
HXDLIN( 277)			_hx_tmp5 = (this->greenMultiplier == ct->greenMultiplier);
            		}
            		else {
HXDLIN( 277)			_hx_tmp5 = false;
            		}
HXDLIN( 277)		if (_hx_tmp5) {
HXDLIN( 277)			_hx_tmp4 = (this->blueMultiplier == ct->blueMultiplier);
            		}
            		else {
HXDLIN( 277)			_hx_tmp4 = false;
            		}
HXDLIN( 277)		if (_hx_tmp4) {
HXDLIN( 277)			if (!(ignoreAlphaMultiplier)) {
HXDLIN( 277)				_hx_tmp3 = (this->alphaMultiplier == ct->alphaMultiplier);
            			}
            			else {
HXDLIN( 277)				_hx_tmp3 = true;
            			}
            		}
            		else {
HXDLIN( 277)			_hx_tmp3 = false;
            		}
HXDLIN( 277)		if (_hx_tmp3) {
HXDLIN( 277)			_hx_tmp2 = (this->redOffset == ct->redOffset);
            		}
            		else {
HXDLIN( 277)			_hx_tmp2 = false;
            		}
HXDLIN( 277)		if (_hx_tmp2) {
HXDLIN( 277)			_hx_tmp1 = (this->greenOffset == ct->greenOffset);
            		}
            		else {
HXDLIN( 277)			_hx_tmp1 = false;
            		}
HXDLIN( 277)		if (_hx_tmp1) {
HXDLIN( 277)			_hx_tmp = (this->blueOffset == ct->blueOffset);
            		}
            		else {
HXDLIN( 277)			_hx_tmp = false;
            		}
HXDLIN( 277)		if (_hx_tmp) {
HXDLIN( 277)			return (this->alphaOffset == ct->alphaOffset);
            		}
            		else {
...
bool ColorTransform_obj::_hx___isDefault(bool ignoreAlphaMultiplier){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_284___isDefault)
HXDLIN( 284)		if (ignoreAlphaMultiplier) {
HXLINE( 286)			bool _hx_tmp;
HXDLIN( 286)			bool _hx_tmp1;
HXDLIN( 286)			bool _hx_tmp2;
HXDLIN( 286)			bool _hx_tmp3;
HXDLIN( 286)			bool _hx_tmp4;
HXDLIN( 286)			if ((this->redMultiplier == (int)1)) {
HXLINE( 286)				_hx_tmp4 = (this->greenMultiplier == (int)1);
            			}
            			else {
HXLINE( 286)				_hx_tmp4 = false;
            			}
HXDLIN( 286)			if (_hx_tmp4) {
HXLINE( 286)				_hx_tmp3 = (this->blueMultiplier == (int)1);
            			}
            			else {
HXLINE( 286)				_hx_tmp3 = false;
            			}
HXDLIN( 286)			if (_hx_tmp3) {
HXLINE( 286)				_hx_tmp2 = (this->redOffset == (int)0);
            			}
            			else {
HXLINE( 286)				_hx_tmp2 = false;
            			}
HXDLIN( 286)			if (_hx_tmp2) {
HXLINE( 286)				_hx_tmp1 = (this->greenOffset == (int)0);
            			}
            			else {
HXLINE( 286)				_hx_tmp1 = false;
            			}
HXDLIN( 286)			if (_hx_tmp1) {
HXLINE( 286)				_hx_tmp = (this->blueOffset == (int)0);
            			}
            			else {
HXLINE( 286)				_hx_tmp = false;
            			}
HXDLIN( 286)			if (_hx_tmp) {
HXLINE( 286)				return (this->alphaOffset == (int)0);
            			}
            			else {
...
HXDLIN( 290)			bool _hx_tmp8;
HXDLIN( 290)			bool _hx_tmp9;
HXDLIN( 290)			bool _hx_tmp10;
HXDLIN( 290)			if ((this->redMultiplier == (int)1)) {
HXLINE( 290)				_hx_tmp10 = (this->greenMultiplier == (int)1);
            			}
            			else {
HXLINE( 290)				_hx_tmp10 = false;
            			}
HXDLIN( 290)			if (_hx_tmp10) {
HXLINE( 290)				_hx_tmp9 = (this->blueMultiplier == (int)1);
            			}
            			else {
HXLINE( 290)				_hx_tmp9 = false;
            			}
HXDLIN( 290)			if (_hx_tmp9) {
HXLINE( 290)				_hx_tmp8 = (this->alphaMultiplier == (int)1);
            			}
            			else {
HXLINE( 290)				_hx_tmp8 = false;
            			}
HXDLIN( 290)			if (_hx_tmp8) {
HXLINE( 290)				_hx_tmp7 = (this->redOffset == (int)0);
            			}
            			else {
HXLINE( 290)				_hx_tmp7 = false;
            			}
HXDLIN( 290)			if (_hx_tmp7) {
HXLINE( 290)				_hx_tmp6 = (this->greenOffset == (int)0);
            			}
            			else {
HXLINE( 290)				_hx_tmp6 = false;
            			}
HXDLIN( 290)			if (_hx_tmp6) {
HXLINE( 290)				_hx_tmp5 = (this->blueOffset == (int)0);
            			}
            			else {
HXLINE( 290)				_hx_tmp5 = false;
            			}
HXDLIN( 290)			if (_hx_tmp5) {
HXLINE( 290)				return (this->alphaOffset == (int)0);
            			}
            			else {
...
void ColorTransform_obj::_hx___setArrays(::Array< Float > colorMultipliers,::Array< Float > colorOffsets){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_299___setArrays)
HXLINE( 301)		colorMultipliers[(int)0] = this->redMultiplier;
HXLINE( 302)		colorMultipliers[(int)1] = this->greenMultiplier;
HXLINE( 303)		colorMultipliers[(int)2] = this->blueMultiplier;
HXLINE( 304)		colorMultipliers[(int)3] = this->alphaMultiplier;
HXLINE( 305)		colorOffsets[(int)0] = this->redOffset;
HXLINE( 306)		colorOffsets[(int)1] = this->greenOffset;
HXLINE( 307)		colorOffsets[(int)2] = this->blueOffset;
HXLINE( 308)		colorOffsets[(int)3] = this->alphaOffset;
            	}
...
int ColorTransform_obj::get_color(){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_322_get_color)
HXDLIN( 322)		int _hx_tmp = ((int)::Std_obj::_hx_int(this->redOffset) << (int)(int)16);
HXDLIN( 322)		int _hx_tmp1 = ((int)_hx_tmp | (int)((int)::Std_obj::_hx_int(this->greenOffset) << (int)(int)8));
HXDLIN( 322)		return ((int)_hx_tmp1 | (int)::Std_obj::_hx_int(this->blueOffset));
            	}
...
int ColorTransform_obj::set_color(int value){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_327_set_color)
HXLINE( 329)		this->redOffset = ((int)((int)value >> (int)(int)16) & (int)(int)255);
HXLINE( 330)		this->greenOffset = ((int)((int)value >> (int)(int)8) & (int)(int)255);
HXLINE( 331)		this->blueOffset = ((int)value & (int)(int)255);
HXLINE( 333)		this->redMultiplier = (int)0;
HXLINE( 334)		this->greenMultiplier = (int)0;
HXLINE( 335)		this->blueMultiplier = (int)0;
HXLINE( 337)		return this->get_color();
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(ColorTransform_obj,set_color,return )
 ...
 ::lime::utils::ArrayBufferView ColorTransform_obj::_hx___toLimeColorMatrix(){
            	HX_GC_STACKFRAME(&_hx_pos_82e72dbfef9da50a_342___toLimeColorMatrix)
HXLINE( 344)		if (hx::IsNull( ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix )) {
HXLINE( 346)			 ::lime::utils::ArrayBufferView this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)20,(int)8);
HXDLIN( 346)			::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix = this1;
            		}
HXLINE( 350)		{
HXLINE( 350)			 ::lime::utils::ArrayBufferView this2 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 350)			Float val = this->redMultiplier;
HXDLIN( 350)			::__hxcpp_memory_set_float(this2->buffer->b,this2->byteOffset,val);
            		}
HXLINE( 351)		{
HXLINE( 351)			 ::lime::utils::ArrayBufferView this3 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 351)			Float val1 = ((Float)this->redOffset / (Float)(int)255);
HXDLIN( 351)			::__hxcpp_memory_set_float(this3->buffer->b,(this3->byteOffset + (int)16),val1);
            		}
HXLINE( 352)		{
HXLINE( 352)			 ::lime::utils::ArrayBufferView this4 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 352)			Float val2 = this->greenMultiplier;
HXDLIN( 352)			::__hxcpp_memory_set_float(this4->buffer->b,(this4->byteOffset + (int)24),val2);
            		}
HXLINE( 353)		{
HXLINE( 353)			 ::lime::utils::ArrayBufferView this5 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 353)			Float val3 = ((Float)this->greenOffset / (Float)(int)255);
HXDLIN( 353)			::__hxcpp_memory_set_float(this5->buffer->b,(this5->byteOffset + (int)36),val3);
            		}
HXLINE( 354)		{
HXLINE( 354)			 ::lime::utils::ArrayBufferView this6 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 354)			Float val4 = this->blueMultiplier;
HXDLIN( 354)			::__hxcpp_memory_set_float(this6->buffer->b,(this6->byteOffset + (int)48),val4);
            		}
HXLINE( 355)		{
HXLINE( 355)			 ::lime::utils::ArrayBufferView this7 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 355)			Float val5 = ((Float)this->blueOffset / (Float)(int)255);
HXDLIN( 355)			::__hxcpp_memory_set_float(this7->buffer->b,(this7->byteOffset + (int)56),val5);
            		}
HXLINE( 356)		{
HXLINE( 356)			 ::lime::utils::ArrayBufferView this8 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 356)			Float val6 = this->alphaMultiplier;
HXDLIN( 356)			::__hxcpp_memory_set_float(this8->buffer->b,(this8->byteOffset + (int)72),val6);
            		}
HXLINE( 357)		{
HXLINE( 357)			 ::lime::utils::ArrayBufferView this9 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 357)			Float val7 = ((Float)this->alphaOffset / (Float)(int)255);
HXDLIN( 357)			::__hxcpp_memory_set_float(this9->buffer->b,(this9->byteOffset + (int)76),val7);
            		}
HXLINE( 359)		return ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
            	}
...
static hx::StaticInfo ColorTransform_obj_sStaticStorageInfo[] = {
	...
	{hx::fsObject /*::lime::utils::ObjectPool_openfl_geom_ColorTransform*/ ,(void *) &ColorTransform_obj::_hx___pool,HX_HCSTRING("__pool","\xfc","\xe3","\x54","\xf9")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
{
{
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::openfl::geom::ColorTransform _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_82e72dbfef9da50a_60_boot)
HXDLIN(  60)			return  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
            		}
...
HXDLIN(  60)			ct->_hx___identity();
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_82e72dbfef9da50a_60_boot)
HXDLIN(  60)		_hx___pool =  ::lime::utils::ObjectPool_openfl_geom_ColorTransform_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0()), ::Dynamic(new _hx_Closure_1()),null());
            	}
}
