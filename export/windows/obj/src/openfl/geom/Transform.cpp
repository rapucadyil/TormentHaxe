...
HXLINE( 265)			::Array< Float > a = ::Array_obj< Float >::__new(16)->init(0,matrix->a)->init(1,matrix->b)->init(2,((Float)0.0))->init(3,((Float)0.0))->init(4,matrix->c)->init(5,matrix->d)->init(6,((Float)0.0))->init(7,((Float)0.0))->init(8,((Float)0.0))->init(9,((Float)0.0))->init(10,((Float)1.0))->init(11,((Float)0.0))->init(12,matrix->tx)->init(13,matrix->ty)->init(14,((Float)0.0))->init(15,((Float)1.0));
HXDLIN( 265)			int length = null();
HXDLIN( 265)			bool fixed = null();
HXDLIN( 265)			 ::openfl::_Vector::FloatVector vector =  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length,fixed,null(),true);
HXDLIN( 265)			{
HXLINE( 265)				int _g1 = (int)0;
HXDLIN( 265)				int _g = a->length;
HXDLIN( 265)				while((_g1 < _g)){
HXLINE( 265)					_g1 = (_g1 + (int)1);
HXDLIN( 265)					int i = (_g1 - (int)1);
HXDLIN( 265)					vector->set(i,a->__get(i));
            				}
            			}
HXDLIN( 265)			return  ::openfl::geom::Matrix3D_obj::__alloc( HX_CTX ,vector);
            		}
