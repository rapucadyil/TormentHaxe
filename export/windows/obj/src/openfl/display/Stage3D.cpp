...
HX_DEFINE_STACK_FRAME(_hx_pos_3e7f1148457df64b_80_new,"openfl.display.Stage3D","new",0x52647737,"openfl.display.Stage3D.new","openfl/display/Stage3D.hx",80,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_104_requestContext3D,"openfl.display.Stage3D","requestContext3D",0x80c219da,"openfl.display.Stage3D.requestContext3D","openfl/display/Stage3D.hx",104,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_120_requestContext3DMatchingProfiles,"openfl.display.Stage3D","requestContext3DMatchingProfiles",0x5b5ae301,"openfl.display.Stage3D.requestContext3DMatchingProfiles","openfl/display/Stage3D.hx",120,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_125___createContext,"openfl.display.Stage3D","__createContext",0x1987b48a,"openfl.display.Stage3D.__createContext","openfl/display/Stage3D.hx",125,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_213___dispatchError,"openfl.display.Stage3D","__dispatchError",0xdb9710e5,"openfl.display.Stage3D.__dispatchError","openfl/display/Stage3D.hx",213,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_223___dispatchCreate,"openfl.display.Stage3D","__dispatchCreate",0x733e9b3f,"openfl.display.Stage3D.__dispatchCreate","openfl/display/Stage3D.hx",223,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_235___resize,"openfl.display.Stage3D","__resize",0x193af2dd,"openfl.display.Stage3D.__resize","openfl/display/Stage3D.hx",235,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_267_get_x,"openfl.display.Stage3D","get_x",0x0609efe6,"openfl.display.Stage3D.get_x","openfl/display/Stage3D.hx",267,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_272_set_x,"openfl.display.Stage3D","set_x",0xeed8e5f2,"openfl.display.Stage3D.set_x","openfl/display/Stage3D.hx",272,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_286_get_y,"openfl.display.Stage3D","get_y",0x0609efe7,"openfl.display.Stage3D.get_y","openfl/display/Stage3D.hx",286,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_291_set_y,"openfl.display.Stage3D","set_y",0xeed8e5f3,"openfl.display.Stage3D.set_y","openfl/display/Stage3D.hx",291,0x37141b9b)
namespace openfl{
namespace display{

void Stage3D_obj::__construct( ::openfl::display::Stage stage){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_80_new)
HXLINE(  82)		super::__construct(null());
HXLINE(  84)		this->_hx___stage = stage;
HXLINE(  86)		this->_hx___height = (int)0;
HXLINE(  87)		this->_hx___projectionTransform =  ::openfl::geom::Matrix3D_obj::__alloc( HX_CTX ,null());
HXLINE(  88)		this->_hx___renderTransform =  ::openfl::geom::Matrix3D_obj::__alloc( HX_CTX ,null());
HXLINE(  89)		this->_hx___width = (int)0;
HXLINE(  90)		this->_hx___x = (int)0;
HXLINE(  91)		this->_hx___y = (int)0;
HXLINE(  93)		this->visible = true;
HXLINE(  95)		bool _hx_tmp;
HXDLIN(  95)		if ((stage->stageWidth > (int)0)) {
HXLINE(  95)			_hx_tmp = (stage->stageHeight > (int)0);
            		}
            		else {
HXLINE(  95)			_hx_tmp = false;
            		}
HXDLIN(  95)		if (_hx_tmp) {
HXLINE(  96)			this->_hx___resize(stage->stageWidth,stage->stageHeight);
            		}
            	}
...
void Stage3D_obj::requestContext3D( ::Dynamic __o_context3DRenderMode, ::Dynamic __o_profile){
 ...
 ::Dynamic profile = __o_profile.Default(0);
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_104_requestContext3D)
HXDLIN( 104)		if (hx::IsNotNull( this->context3D )) {
HXLINE( 106)			::haxe::Timer_obj::delay(this->_hx___dispatchCreate_dyn(),(int)1);
            		}
            		else {
HXLINE( 108)			if (!(this->_hx___contextRequested)) {
HXLINE( 110)				this->_hx___contextRequested = true;
HXLINE( 111)				::haxe::Timer_obj::delay(this->_hx___createContext_dyn(),(int)1);
            			}
            		}
            	}
...
void Stage3D_obj::requestContext3DMatchingProfiles( ::openfl::_Vector::ObjectVector profiles){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_120_requestContext3DMatchingProfiles)
HXDLIN( 120)		this->requestContext3D(null(),null());
            	}
...
void Stage3D_obj::_hx___createContext(){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_125___createContext)
HXLINE( 127)		 ::openfl::display::Stage stage = this->_hx___stage;
HXLINE( 128)		 ::openfl::display::DisplayObjectRenderer renderer = stage->_hx___renderer;
HXLINE( 130)		bool _hx_tmp;
HXDLIN( 130)		if ((renderer->_hx___type != HX_("cairo",88,30,19,41))) {
HXLINE( 130)			_hx_tmp = (renderer->_hx___type == HX_("canvas",d8,54,42,b8));
            		}
            		else {
HXLINE( 130)			_hx_tmp = true;
            		}
HXDLIN( 130)		if (_hx_tmp) {
HXLINE( 132)			this->_hx___dispatchError();
HXLINE( 133)			return;
            		}
HXLINE( 137)		if ((renderer->_hx___type == HX_("opengl",6f,64,94,21))) {
HXLINE( 142)			this->context3D =  ::openfl::display3D::Context3D_obj::__alloc( HX_CTX ,stage,stage->context3D->_hx___contextState,hx::ObjectPtr<OBJ_>(this));
HXLINE( 144)			this->_hx___dispatchCreate();
            		}
            		else {
HXLINE( 146)			bool _hx_tmp1 = (renderer->_hx___type == HX_("dom",82,42,4c,00));
            		}
            	}
...
void Stage3D_obj::_hx___dispatchError(){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_213___dispatchError)
HXLINE( 215)		this->_hx___contextRequested = false;
HXLINE( 216)		this->dispatchEvent( ::openfl::events::ErrorEvent_obj::__alloc( HX_CTX ,HX_("error",c8,cb,29,73),false,false,HX_("Context3D not available",9c,fc,63,d3),null()));
            	}
...
void Stage3D_obj::_hx___dispatchCreate(){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_223___dispatchCreate)
HXDLIN( 223)		if (this->_hx___contextRequested) {
HXLINE( 225)			this->_hx___contextRequested = false;
HXLINE( 226)			this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("context3DCreate",7c,bf,59,7b),null(),null()));
            		}
            	}
...
void Stage3D_obj::_hx___resize(int width,int height){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_235___resize)
HXDLIN( 235)		bool _hx_tmp;
HXDLIN( 235)		if ((width == this->_hx___width)) {
HXDLIN( 235)			_hx_tmp = (height != this->_hx___height);
            		}
            		else {
HXDLIN( 235)			_hx_tmp = true;
            		}
HXDLIN( 235)		if (_hx_tmp) {
HXLINE( 246)			 ::openfl::geom::Matrix3D _hx_tmp1 = this->_hx___projectionTransform;
HXLINE( 247)			int a;
HXDLIN( 247)			if ((width > (int)0)) {
HXLINE( 247)				a = width;
            			}
            			else {
HXLINE( 247)				a = (int)1;
...
HXLINE( 248)			int a1;
HXDLIN( 248)			if ((height > (int)0)) {
HXLINE( 248)				a1 = height;
            			}
            			else {
HXLINE( 248)				a1 = (int)1;
            			}
HXLINE( 246)			::Array< Float > a2 = ::Array_obj< Float >::__new(16)->init(0,((Float)((Float)2.0) / (Float)a))->init(1,((Float)0.0))->init(2,((Float)0.0))->init(3,((Float)0.0))->init(4,((Float)0.0))->init(5,((Float)((Float)-2.0) / (Float)a1))->init(6,((Float)0.0))->init(7,((Float)0.0))->init(8,((Float)0.0))->init(9,((Float)0.0))->init(10,((Float)-0.001))->init(11,((Float)0.0))->init(12,((Float)-1.0))->init(13,((Float)1.0))->init(14,((Float)0.0))->init(15,((Float)1.0));
HXDLIN( 246)			int length = null();
HXDLIN( 246)			bool fixed = null();
HXDLIN( 246)			 ::openfl::_Vector::FloatVector vector =  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length,fixed,null(),true);
HXDLIN( 246)			{
HXLINE( 246)				int _g1 = (int)0;
HXDLIN( 246)				int _g = a2->length;
HXDLIN( 246)				while((_g1 < _g)){
HXLINE( 246)					_g1 = (_g1 + (int)1);
HXDLIN( 246)					int i = (_g1 - (int)1);
HXDLIN( 246)					vector->set(i,a2->__get(i));
            				}
            			}
HXDLIN( 246)			_hx_tmp1->copyRawDataFrom(vector,null(),null());
HXLINE( 253)			this->_hx___renderTransform->identity();
HXLINE( 254)			this->_hx___renderTransform->appendTranslation(this->_hx___x,this->_hx___y,(int)0);
HXLINE( 255)			this->_hx___renderTransform->append(this->_hx___projectionTransform);
HXLINE( 257)			this->_hx___width = width;
HXLINE( 258)			this->_hx___height = height;
            		}
            	}
...
Float Stage3D_obj::get_x(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_267_get_x)
HXDLIN( 267)		return this->_hx___x;
            	}
...
Float Stage3D_obj::set_x(Float value){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_272_set_x)
HXLINE( 274)		if ((this->_hx___x == value)) {
HXLINE( 274)			return value;
            		}
HXLINE( 275)		this->_hx___x = value;
HXLINE( 276)		this->_hx___renderTransform->identity();
HXLINE( 277)		this->_hx___renderTransform->appendTranslation(this->_hx___x,this->_hx___y,(int)0);
HXLINE( 278)		this->_hx___renderTransform->append(this->_hx___projectionTransform);
...
Float Stage3D_obj::get_y(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_286_get_y)
HXDLIN( 286)		return this->_hx___y;
            	}
...
Float Stage3D_obj::set_y(Float value){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_291_set_y)
HXLINE( 293)		if ((this->_hx___y == value)) {
HXLINE( 293)			return value;
            		}
HXLINE( 294)		this->_hx___y = value;
HXLINE( 295)		this->_hx___renderTransform->identity();
HXLINE( 296)		this->_hx___renderTransform->appendTranslation(this->_hx___x,this->_hx___y,(int)0);
HXLINE( 297)		this->_hx___renderTransform->append(this->_hx___projectionTransform);
