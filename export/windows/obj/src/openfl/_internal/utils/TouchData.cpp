...
HX_DEFINE_STACK_FRAME(_hx_pos_75efee5aa8d131a4_28_new,"openfl._internal.utils.TouchData","new",0x621b4fae,"openfl._internal.utils.TouchData.new","openfl/_internal/utils/TouchData.hx",28,0xb785a0c5)
HX_LOCAL_STACK_FRAME(_hx_pos_75efee5aa8d131a4_33_reset,"openfl._internal.utils.TouchData","reset",0xe8e8b89d,"openfl._internal.utils.TouchData.reset","openfl/_internal/utils/TouchData.hx",33,0xb785a0c5)
HX_LOCAL_STACK_FRAME(_hx_pos_75efee5aa8d131a4_18_boot,"openfl._internal.utils.TouchData","boot",0x6de36924,"openfl._internal.utils.TouchData.boot","openfl/_internal/utils/TouchData.hx",18,0xb785a0c5)
namespace openfl{
namespace _internal{
namespace utils{

void TouchData_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_75efee5aa8d131a4_28_new)
...
void TouchData_obj::reset(){
            	HX_STACKFRAME(&_hx_pos_75efee5aa8d131a4_33_reset)
...
HX_DEFINE_DYNAMIC_FUNC0(TouchData_obj,reset,(void))
 ...
 ::lime::utils::ObjectPool_openfl__internal_utils_TouchData TouchData_obj::_hx___pool;
...
bool TouchData_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"__pool") ) { _hx___pool=ioValue.Cast<  ::lime::utils::ObjectPool_openfl__internal_utils_TouchData >(); return true; }
	}
	return false;
}
...
static hx::StaticInfo TouchData_obj_sStaticStorageInfo[] = {
	{hx::fsObject /*::lime::utils::ObjectPool_openfl__internal_utils_TouchData*/ ,(void *) &TouchData_obj::_hx___pool,HX_HCSTRING("__pool","\xfc","\xe3","\x54","\xf9")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
{
{
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::openfl::_internal::utils::TouchData _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_75efee5aa8d131a4_18_boot)
HXDLIN(  18)			return  ::openfl::_internal::utils::TouchData_obj::__alloc( HX_CTX );
            		}
            		HX_END_LOCAL_FUNC0(return)

            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            		void _hx_run( ::openfl::_internal::utils::TouchData data){
            			HX_STACKFRAME(&_hx_pos_75efee5aa8d131a4_18_boot)
HXDLIN(  18)			data->reset();
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_75efee5aa8d131a4_18_boot)
HXDLIN(  18)		_hx___pool =  ::lime::utils::ObjectPool_openfl__internal_utils_TouchData_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0()), ::Dynamic(new _hx_Closure_1()),null());
            	}
}
