...
HX_DEFINE_STACK_FRAME(_hx_pos_35eccd5eb8f43d1d_60_new,"openfl._internal.renderer.ShaderBuffer","new",0x33d81cf2,"openfl._internal.renderer.ShaderBuffer.new","openfl/_internal/renderer/ShaderBuffer.hx",60,0x9cbf111f)
HX_LOCAL_STACK_FRAME(_hx_pos_35eccd5eb8f43d1d_85_addBoolOverride,"openfl._internal.renderer.ShaderBuffer","addBoolOverride",0x6991e7e9,"openfl._internal.renderer.ShaderBuffer.addBoolOverride","openfl/_internal/renderer/ShaderBuffer.hx",85,0x9cbf111f)
HX_LOCAL_STACK_FRAME(_hx_pos_35eccd5eb8f43d1d_94_addFloatOverride,"openfl._internal.renderer.ShaderBuffer","addFloatOverride",0x611e3d55,"openfl._internal.renderer.ShaderBuffer.addFloatOverride","openfl/_internal/renderer/ShaderBuffer.hx",94,0x9cbf111f)
HX_LOCAL_STACK_FRAME(_hx_pos_35eccd5eb8f43d1d_103_addIntOverride,"openfl._internal.renderer.ShaderBuffer","addIntOverride",0x5001b268,"openfl._internal.renderer.ShaderBuffer.addIntOverride","openfl/_internal/renderer/ShaderBuffer.hx",103,0x9cbf111f)
HX_LOCAL_STACK_FRAME(_hx_pos_35eccd5eb8f43d1d_112_clearOverride,"openfl._internal.renderer.ShaderBuffer","clearOverride",0x43b99c0b,"openfl._internal.renderer.ShaderBuffer.clearOverride","openfl/_internal/renderer/ShaderBuffer.hx",112,0x9cbf111f)
HX_LOCAL_STACK_FRAME(_hx_pos_35eccd5eb8f43d1d_122_update,"openfl._internal.renderer.ShaderBuffer","update",0xfab9e0b7,"openfl._internal.renderer.ShaderBuffer.update","openfl/_internal/renderer/ShaderBuffer.hx",122,0x9cbf111f)
namespace openfl{
namespace _internal{
namespace renderer{

void ShaderBuffer_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_35eccd5eb8f43d1d_60_new)
HXLINE(  62)		this->inputRefs = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  63)		this->inputFilter = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  64)		this->inputMipFilter = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  65)		this->inputs = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  66)		this->inputWrap = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  69)		this->overrideIntNames = ::Array_obj< ::String >::__new(0);
HXLINE(  70)		this->overrideIntValues = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  71)		this->overrideFloatNames = ::Array_obj< ::String >::__new(0);
HXLINE(  72)		this->overrideFloatValues = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  73)		this->overrideBoolNames = ::Array_obj< ::String >::__new(0);
HXLINE(  74)		this->overrideBoolValues = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  75)		this->paramLengths = ::Array_obj< int >::__new(0);
HXLINE(  76)		this->paramPositions = ::Array_obj< int >::__new(0);
HXLINE(  77)		this->paramRefs_Bool = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  78)		this->paramRefs_Float = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  79)		this->paramRefs_Int = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  80)		this->paramTypes = ::Array_obj< int >::__new(0);
            	}
...
void ShaderBuffer_obj::addBoolOverride(::String name,::Array< bool > values){
            	HX_STACKFRAME(&_hx_pos_35eccd5eb8f43d1d_85_addBoolOverride)
HXLINE(  87)		this->overrideBoolNames[this->overrideBoolCount] = name;
HXLINE(  88)		this->overrideBoolValues[this->overrideBoolCount] = values;
HXLINE(  89)		this->overrideBoolCount++;
            	}
...
void ShaderBuffer_obj::addFloatOverride(::String name,::Array< Float > values){
            	HX_STACKFRAME(&_hx_pos_35eccd5eb8f43d1d_94_addFloatOverride)
HXLINE(  96)		this->overrideFloatNames[this->overrideFloatCount] = name;
HXLINE(  97)		this->overrideFloatValues[this->overrideFloatCount] = values;
HXLINE(  98)		this->overrideFloatCount++;
            	}
...
void ShaderBuffer_obj::addIntOverride(::String name,::Array< int > values){
            	HX_STACKFRAME(&_hx_pos_35eccd5eb8f43d1d_103_addIntOverride)
HXLINE( 105)		this->overrideIntNames[this->overrideIntCount] = name;
HXLINE( 106)		this->overrideIntValues[this->overrideIntCount] = values;
HXLINE( 107)		this->overrideIntCount++;
            	}
...
void ShaderBuffer_obj::clearOverride(){
            	HX_STACKFRAME(&_hx_pos_35eccd5eb8f43d1d_112_clearOverride)
HXLINE( 115)		this->overrideIntCount = (int)0;
HXLINE( 116)		this->overrideFloatCount = (int)0;
HXLINE( 117)		this->overrideBoolCount = (int)0;
            	}
...
void ShaderBuffer_obj::update( ::openfl::display::GraphicsShader shader){
            	HX_GC_STACKFRAME(&_hx_pos_35eccd5eb8f43d1d_122_update)
HXLINE( 124)		this->inputCount = (int)0;
HXLINE( 126)		this->overrideIntCount = (int)0;
HXLINE( 127)		this->overrideFloatCount = (int)0;
HXLINE( 128)		this->overrideBoolCount = (int)0;
HXLINE( 129)		this->paramBoolCount = (int)0;
HXLINE( 130)		this->paramCount = (int)0;
HXLINE( 131)		this->paramDataLength = (int)0;
HXLINE( 132)		this->paramFloatCount = (int)0;
HXLINE( 133)		this->paramIntCount = (int)0;
HXLINE( 134)		this->shader = null();
HXLINE( 136)		if (hx::IsNull( shader )) {
HXLINE( 136)			return;
            		}
HXLINE( 138)		shader->_hx___init();
HXLINE( 140)		this->inputCount = shader->_hx___inputBitmapData->length;
HXLINE( 141)		 ::openfl::display::ShaderInput_openfl_display_BitmapData input;
HXLINE( 143)		{
HXLINE( 143)			int _g1 = (int)0;
HXDLIN( 143)			int _g = this->inputCount;
HXDLIN( 143)			while((_g1 < _g)){
HXLINE( 143)				_g1 = (_g1 + (int)1);
HXDLIN( 143)				int i = (_g1 - (int)1);
HXLINE( 145)				input = shader->_hx___inputBitmapData->__get(i).StaticCast<  ::openfl::display::ShaderInput_openfl_display_BitmapData >();
HXLINE( 146)				this->inputs[i] = input->input;
HXLINE( 147)				this->inputFilter[i] = input->filter;
HXLINE( 148)				this->inputMipFilter[i] = input->mipFilter;
HXLINE( 149)				this->inputRefs[i] = input;
HXLINE( 150)				this->inputWrap[i] = input->wrap;
            			}
            		}
HXLINE( 154)		int boolCount = shader->_hx___paramBool->length;
HXLINE( 155)		int floatCount = shader->_hx___paramFloat->length;
HXLINE( 156)		int intCount = shader->_hx___paramInt->length;
HXLINE( 157)		this->paramCount = ((boolCount + floatCount) + intCount);
HXLINE( 158)		this->paramBoolCount = boolCount;
HXLINE( 159)		this->paramFloatCount = floatCount;
HXLINE( 160)		this->paramIntCount = intCount;
HXLINE( 162)		int paramLength = (int)0;
HXLINE( 163)		int length = (int)0;
HXDLIN( 163)		int p = (int)0;
HXLINE( 164)		 ::openfl::display::ShaderParameter_Bool param;
HXLINE( 166)		{
HXLINE( 166)			int _g11 = (int)0;
HXDLIN( 166)			int _g2 = boolCount;
HXDLIN( 166)			while((_g11 < _g2)){
HXLINE( 166)				_g11 = (_g11 + (int)1);
HXDLIN( 166)				int i1 = (_g11 - (int)1);
HXLINE( 168)				param = shader->_hx___paramBool->__get(i1).StaticCast<  ::openfl::display::ShaderParameter_Bool >();
HXLINE( 170)				this->paramPositions[p] = this->paramDataLength;
HXLINE( 171)				if (hx::IsNotNull( param->value )) {
HXLINE( 171)					length = param->value->length;
            				}
            				else {
HXLINE( 171)					length = (int)0;
            				}
HXLINE( 172)				this->paramLengths[p] = length;
HXLINE( 173)				 ::openfl::_internal::renderer::ShaderBuffer _hx_tmp = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 173)				_hx_tmp->paramDataLength = (_hx_tmp->paramDataLength + length);
HXLINE( 174)				this->paramTypes[p] = (int)0;
HXLINE( 176)				this->paramRefs_Bool[i1] = param;
HXLINE( 177)				p = (p + (int)1);
            			}
            		}
HXLINE( 181)		 ::openfl::display::ShaderParameter_Float param1;
HXLINE( 183)		{
HXLINE( 183)			int _g12 = (int)0;
HXDLIN( 183)			int _g3 = floatCount;
HXDLIN( 183)			while((_g12 < _g3)){
HXLINE( 183)				_g12 = (_g12 + (int)1);
HXDLIN( 183)				int i2 = (_g12 - (int)1);
HXLINE( 185)				param1 = shader->_hx___paramFloat->__get(i2).StaticCast<  ::openfl::display::ShaderParameter_Float >();
HXLINE( 187)				this->paramPositions[p] = this->paramDataLength;
HXLINE( 188)				if (hx::IsNotNull( param1->value )) {
HXLINE( 188)					length = param1->value->length;
            				}
            				else {
HXLINE( 188)					length = (int)0;
            				}
HXLINE( 189)				this->paramLengths[p] = length;
HXLINE( 190)				 ::openfl::_internal::renderer::ShaderBuffer _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 190)				_hx_tmp1->paramDataLength = (_hx_tmp1->paramDataLength + length);
HXLINE( 191)				this->paramTypes[p] = (int)1;
HXLINE( 193)				this->paramRefs_Float[i2] = param1;
HXLINE( 194)				p = (p + (int)1);
            			}
            		}
HXLINE( 198)		 ::openfl::display::ShaderParameter_Int param2;
HXLINE( 200)		{
HXLINE( 200)			int _g13 = (int)0;
HXDLIN( 200)			int _g4 = intCount;
HXDLIN( 200)			while((_g13 < _g4)){
HXLINE( 200)				_g13 = (_g13 + (int)1);
HXDLIN( 200)				int i3 = (_g13 - (int)1);
HXLINE( 202)				param2 = shader->_hx___paramInt->__get(i3).StaticCast<  ::openfl::display::ShaderParameter_Int >();
HXLINE( 204)				this->paramPositions[p] = this->paramDataLength;
HXLINE( 205)				if (hx::IsNotNull( param2->value )) {
HXLINE( 205)					length = param2->value->length;
            				}
            				else {
HXLINE( 205)					length = (int)0;
            				}
HXLINE( 206)				this->paramLengths[p] = length;
HXLINE( 207)				 ::openfl::_internal::renderer::ShaderBuffer _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 207)				_hx_tmp2->paramDataLength = (_hx_tmp2->paramDataLength + length);
HXLINE( 208)				this->paramTypes[p] = (int)2;
HXLINE( 210)				this->paramRefs_Int[i3] = param2;
HXLINE( 211)				p = (p + (int)1);
            			}
            		}
HXLINE( 215)		if ((this->paramDataLength > (int)0)) {
HXLINE( 217)			if (hx::IsNull( this->paramData )) {
HXLINE( 219)				 ::Dynamic elements = this->paramDataLength;
HXDLIN( 219)				 ::lime::utils::ArrayBufferView this1;
HXDLIN( 219)				if (hx::IsNotNull( elements )) {
HXLINE( 219)					this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements,(int)8);
            				}
            				else {
HXLINE( 219)					HX_STACK_DO_THROW(HX_("Invalid constructor arguments for Float32Array",8e,c1,f4,d4));
            				}
HXDLIN( 219)				this->paramData = this1;
            			}
            			else {
HXLINE( 221)				if ((this->paramDataLength > this->paramData->length)) {
HXLINE( 223)					 ::Dynamic elements1 = this->paramDataLength;
HXDLIN( 223)					 ::lime::utils::ArrayBufferView this2;
HXDLIN( 223)					if (hx::IsNotNull( elements1 )) {
HXLINE( 223)						this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements1,(int)8);
            					}
            					else {
HXLINE( 223)						HX_STACK_DO_THROW(HX_("Invalid constructor arguments for Float32Array",8e,c1,f4,d4));
            					}
HXDLIN( 223)					 ::lime::utils::ArrayBufferView data = this2;
HXLINE( 224)					{
HXLINE( 224)						 ::lime::utils::ArrayBufferView view = this->paramData;
HXDLIN( 224)						int offset = (int)0;
HXDLIN( 224)						if (hx::IsNotNull( view )) {
HXLINE( 224)							 ::haxe::io::Bytes data1 = data->buffer;
HXDLIN( 224)							data1->blit((offset * data->bytesPerElement),view->buffer,view->byteOffset,view->byteLength);
            						}
            						else {
HXLINE( 224)							HX_STACK_DO_THROW(HX_("Invalid .set call. either view, or array must be not-null.",64,ba,b7,6c));
            						}
            					}
HXLINE( 225)					this->paramData = data;
            				}
            			}
            		}
HXLINE( 231)		int boolIndex = (int)0;
HXLINE( 232)		int floatIndex = (int)0;
HXLINE( 233)		int intIndex = (int)0;
HXLINE( 235)		int paramPosition = (int)0;
HXLINE( 236)		 ::openfl::display::ShaderParameter_Bool boolParam;
HXDLIN( 236)		 ::openfl::display::ShaderParameter_Float floatParam;
HXDLIN( 236)		 ::openfl::display::ShaderParameter_Int intParam;
HXDLIN( 236)		int length1;
HXLINE( 238)		{
HXLINE( 238)			int _g14 = (int)0;
HXDLIN( 238)			int _g5 = this->paramCount;
HXDLIN( 238)			while((_g14 < _g5)){
HXLINE( 238)				_g14 = (_g14 + (int)1);
HXDLIN( 238)				int i4 = (_g14 - (int)1);
HXLINE( 240)				length1 = this->paramLengths->__get(i4);
HXLINE( 242)				if ((i4 < boolCount)) {
HXLINE( 244)					boolParam = this->paramRefs_Bool->__get(boolIndex).StaticCast<  ::openfl::display::ShaderParameter_Bool >();
HXLINE( 245)					boolIndex = (boolIndex + (int)1);
HXLINE( 247)					{
HXLINE( 247)						int _g31 = (int)0;
HXDLIN( 247)						int _g21 = length1;
HXDLIN( 247)						while((_g31 < _g21)){
HXLINE( 247)							_g31 = (_g31 + (int)1);
HXDLIN( 247)							int j = (_g31 - (int)1);
HXLINE( 249)							{
HXLINE( 249)								 ::lime::utils::ArrayBufferView this3 = this->paramData;
HXDLIN( 249)								Float val;
HXDLIN( 249)								if (boolParam->value->__get(j)) {
HXLINE( 249)									val = (int)1;
            								}
            								else {
HXLINE( 249)									val = (int)0;
            								}
HXDLIN( 249)								{
HXLINE( 249)									int this4 = this3->byteOffset;
HXDLIN( 249)									::__hxcpp_memory_set_float(this3->buffer->b,(this4 + (paramPosition * (int)4)),val);
            								}
            							}
...
HXLINE( 254)					if ((i4 < (boolCount + floatCount))) {
HXLINE( 256)						floatParam = this->paramRefs_Float->__get(floatIndex).StaticCast<  ::openfl::display::ShaderParameter_Float >();
HXLINE( 257)						floatIndex = (floatIndex + (int)1);
HXLINE( 259)						{
HXLINE( 259)							int _g32 = (int)0;
HXDLIN( 259)							int _g22 = length1;
HXDLIN( 259)							while((_g32 < _g22)){
HXLINE( 259)								_g32 = (_g32 + (int)1);
HXDLIN( 259)								int j1 = (_g32 - (int)1);
HXLINE( 261)								{
HXLINE( 261)									 ::lime::utils::ArrayBufferView this5 = this->paramData;
HXDLIN( 261)									Float val1 = floatParam->value->__get(j1);
HXDLIN( 261)									{
HXLINE( 261)										int this6 = this5->byteOffset;
HXDLIN( 261)										::__hxcpp_memory_set_float(this5->buffer->b,(this6 + (paramPosition * (int)4)),val1);
            									}
            								}
HXLINE( 262)								paramPosition = (paramPosition + (int)1);
            							}
            						}
            					}
            					else {
HXLINE( 268)						intParam = this->paramRefs_Int->__get(intIndex).StaticCast<  ::openfl::display::ShaderParameter_Int >();
HXLINE( 269)						intIndex = (intIndex + (int)1);
HXLINE( 271)						{
HXLINE( 271)							int _g33 = (int)0;
HXDLIN( 271)							int _g23 = length1;
HXDLIN( 271)							while((_g33 < _g23)){
HXLINE( 271)								_g33 = (_g33 + (int)1);
HXDLIN( 271)								int j2 = (_g33 - (int)1);
HXLINE( 273)								{
HXLINE( 273)									 ::lime::utils::ArrayBufferView this7 = this->paramData;
HXDLIN( 273)									Float val2 = intParam->value->__get(j2);
HXDLIN( 273)									{
HXLINE( 273)										int this8 = this7->byteOffset;
HXDLIN( 273)										::__hxcpp_memory_set_float(this7->buffer->b,(this8 + (paramPosition * (int)4)),val2);
            									}
            								}
HXLINE( 274)								paramPosition = (paramPosition + (int)1);
            							}
            						}
            					}
            				}
