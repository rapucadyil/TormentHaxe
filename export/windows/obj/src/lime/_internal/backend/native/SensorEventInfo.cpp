...
HX_DEFINE_STACK_FRAME(_hx_pos_60e5fd49cce3a06e_1045_new,"lime._internal.backend.native.SensorEventInfo","new",0xcd81dd2e,"lime._internal.backend.native.SensorEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",1045,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_60e5fd49cce3a06e_1058_clone,"lime._internal.backend.native.SensorEventInfo","clone",0x46c86fab,"lime._internal.backend.native.SensorEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",1058,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
Float z = __o_z.Default(0);
            	HX_STACKFRAME(&_hx_pos_60e5fd49cce3a06e_1045_new)
HXLINE(1047)		this->type = type;
HXLINE(1048)		this->id = id;
HXLINE(1049)		this->x = x;
HXLINE(1050)		this->y = y;
HXLINE(1051)		this->z = z;
            	}
...
bool SensorEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::SensorEventInfo SensorEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_60e5fd49cce3a06e_1058_clone)
HXDLIN(1058)		return  ::lime::_internal::backend::native::SensorEventInfo_obj::__alloc( HX_CTX ,this->type,this->id,this->x,this->y,this->z);
            	}
