...
HX_DEFINE_STACK_FRAME(_hx_pos_c8b942935957ff96_19_new,"openfl.display.Preloader","new",0x5c0f09be,"openfl.display.Preloader.new","openfl/display/Preloader.hx",19,0xc399db74)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c8b942935957ff96_74_update,"openfl.display.Preloader","update",0xdd75fb6b,"openfl.display.Preloader.update","openfl/display/Preloader.hx",74,0xc399db74)
HX_LOCAL_STACK_FRAME(_hx_pos_c8b942935957ff96_96_display_onUnload,"openfl.display.Preloader","display_onUnload",0xa1bcd03d,"openfl.display.Preloader.display_onUnload","openfl/display/Preloader.hx",96,0xc399db74)
namespace openfl{
namespace display{

void Preloader_obj::__construct( ::openfl::display::Sprite display){
            	HX_GC_STACKFRAME(&_hx_pos_c8b942935957ff96_19_new)
HXLINE(  22)		this->onComplete =  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX );
...
HXLINE(  45)		this->ready = true;
HXLINE(  48)		::openfl::Lib_obj::get_current()->get_loaderInfo()->_hx___complete();
HXLINE(  51)		if (hx::IsNotNull( this->display )) {
HXLINE(  53)			 ::openfl::events::Event complete =  ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("complete",b9,00,c8,7f),true,true);
HXLINE(  54)			this->display->dispatchEvent(complete);
HXLINE(  56)			if (!(complete->isDefaultPrevented())) {
HXLINE(  58)				 ::openfl::display::Sprite _hx_tmp = this->display;
HXDLIN(  58)				_hx_tmp->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("unload",ff,a0,8c,65),null(),null()));
            			}
            		}
            		else {
HXLINE(  64)			if (!(this->complete)) {
HXLINE(  65)				this->complete = true;
HXLINE(  66)				this->onComplete->dispatch();
            			}
            		}
            	}
...
void Preloader_obj::update(int loaded,int total){
            	HX_GC_STACKFRAME(&_hx_pos_c8b942935957ff96_74_update)
HXLINE(  77)		::openfl::Lib_obj::get_current()->get_loaderInfo()->_hx___update(loaded,total);
HXLINE(  80)		if (hx::IsNotNull( this->display )) {
HXLINE(  82)			 ::openfl::display::Sprite _hx_tmp = this->display;
HXDLIN(  82)			_hx_tmp->dispatchEvent( ::openfl::events::ProgressEvent_obj::__alloc( HX_CTX ,HX_("progress",ad,f7,2a,86),true,true,loaded,total));
            		}
            	}
...
void Preloader_obj::display_onUnload( ::openfl::events::Event event){
            	HX_STACKFRAME(&_hx_pos_c8b942935957ff96_96_display_onUnload)
HXLINE(  98)		if (hx::IsNotNull( this->display )) {
HXLINE( 100)			this->display->removeEventListener(HX_("unload",ff,a0,8c,65),this->display_onUnload_dyn(),null());
HXLINE( 102)			 ::openfl::display::DisplayObjectContainer _hx_tmp = this->display->parent;
HXDLIN( 102)			if (hx::IsEq( _hx_tmp,::openfl::Lib_obj::get_current() )) {
HXLINE( 104)				::openfl::Lib_obj::get_current()->removeChild(this->display);
            			}
HXLINE( 108)			::openfl::Lib_obj::get_current()->stage->set_focus(null());
HXLINE( 109)			this->display = null();
            		}
HXLINE( 113)		if (this->ready) {
HXLINE( 115)			if (!(this->complete)) {
HXLINE( 116)				this->complete = true;
HXLINE( 117)				this->onComplete->dispatch();
            			}
            		}
            	}
